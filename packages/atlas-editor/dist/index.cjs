...
var atlasHistory = require('@atlas/atlas-history');
var atlasInput = require('@atlas/atlas-input');
var atlasPlugin = require('@atlas/atlas-plugin');
var atlasRenderer = require('@atlas/atlas-renderer');
var atlasSelection = require('@atlas/atlas-selection');
...
var HistoryIntegration = class {
  ...
  recordState(id, label, state) {
    const entry = atlasHistory.createHistoryEntry(id, label, state);
...
var Editor = class {
  ...
  constructor(options) {
    ...
    this.services = {
      history: options.services?.history ?? new atlasHistory.HistoryManager(),
      input: options.services?.input ?? new atlasInput.InputManager(),
      plugins: options.services?.plugins ?? new atlasPlugin.DefaultPluginManager(),
      renderer: options.services?.renderer ?? new atlasRenderer.RendererRuntime(),
      selection: options.services?.selection ?? new atlasSelection.SelectionManager()
    };
...
exports.BudgetSeverity = BudgetSeverity;
exports.CommandIntegration = CommandIntegration;
exports.DocumentManager = DocumentManager;
exports.Editor = Editor;
exports.EditorLifecycleStage = EditorLifecycleStage;
exports.EditorManager = EditorManager;
exports.EditorRuntimeStatus = EditorRuntimeStatus;
exports.HistoryIntegration = HistoryIntegration;
exports.InputIntegration = InputIntegration;
exports.IntegrationContext = IntegrationContext;
exports.ModeManager = ModeManager;
exports.PerformanceBudget = PerformanceBudget;
exports.PluginIntegration = PluginIntegration;
exports.RendererIntegration = RendererIntegration;
exports.RuntimeMetrics = RuntimeMetrics;
exports.SelectionIntegration = SelectionIntegration;
exports.SessionManager = SessionManager;
exports.ToolManager = ToolManager;
exports.WorkspaceManager = WorkspaceManager;
exports.createEditor = createEditor;
exports.createEditorMetadata = createEditorMetadata;
exports.createEditorRuntimeState = createEditorRuntimeState;
exports.createSetActiveDocumentCommand = createSetActiveDocumentCommand;
exports.createSetActiveToolCommand = createSetActiveToolCommand;
exports.createSetActiveWorkspaceCommand = createSetActiveWorkspaceCommand;
exports.createSetEditorModeCommand = createSetEditorModeCommand;
exports.createSetLifecycleCommand = createSetLifecycleCommand;
exports.createStartSessionCommand = createStartSessionCommand;
exports.diagnoseEditor = diagnoseEditor;
exports.reviseEditorState = reviseEditorState;
