import { createHttpStatus, DefaultHttpHeaders, DefaultHttpProtocolRegistry } from '@atlas/atlas-http';
...
var DefaultResponseBuilder = class {
  ...
  metadata;
  lifecycle;
  statusValue = createHttpStatus(200, "OK");
  headersValue = new DefaultHttpHeaders();
