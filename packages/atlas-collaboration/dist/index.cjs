...
__export(index_exports, {
  ...
  CollaborationWorkflowState: () => CollaborationWorkflowState,
  ConflictResolutionStrategy: () => ConflictResolutionStrategy,
  PresenceStatus: () => PresenceStatus,
  SynchronizationState: () => SynchronizationState,
  appendHistory: () => appendHistory,
  canCollaborate: () => canCollaborate,
  collaborationDeliverableNames: () => collaborationDeliverableNames,
  createAnnotation: () => createAnnotation,
  createCollaborationCore: () => createCollaborationCore,
  createCollaborationDeliverable: () => createCollaborationDeliverable,
  createCollaborationEvent: () => createCollaborationEvent,
  createCollaborationSession: () => createCollaborationSession,
  createCollaborationUser: () => createCollaborationUser,
  createComment: () => createComment,
  createHistoryEntry: () => createHistoryEntry,
  createPresence: () => createPresence,
  createRemoteCursor: () => createRemoteCursor,
  createSharedDocument: () => createSharedDocument,
  createSynchronizationSnapshot: () => createSynchronizationSnapshot
});
