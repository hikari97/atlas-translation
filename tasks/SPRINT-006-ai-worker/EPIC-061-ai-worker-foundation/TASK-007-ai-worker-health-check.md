...
# TASK-007 — Health Check

## Summary

Implement health and readiness check contracts for local and deployment use.
...
After this task is complete, Atlas Studio AI worker supports the **Health Check** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Health Check**.
...
- [ ] `Health Check` is implemented inside the allowed AI worker paths.
...
TASK-008-ai-worker-error-model.md
