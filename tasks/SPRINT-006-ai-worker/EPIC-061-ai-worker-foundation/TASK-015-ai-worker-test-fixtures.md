...
# TASK-015 — Test Fixtures

## Summary

Create deterministic fixtures for settings, files, images, and worker context.
...
After this task is complete, Atlas Studio AI worker supports the **Test Fixtures** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Test Fixtures**.
...
- [ ] `Test Fixtures` is implemented inside the allowed AI worker paths.
...
TASK-016-ai-worker-foundation-tests.md
