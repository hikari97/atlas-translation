...
# TASK-003 — Source Structure

## Summary

Create a clear source structure for API, core, jobs, engines, providers, pipelines, storage, observability, and tests.
...
After this task is complete, Atlas Studio AI worker supports the **Source Structure** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Source Structure**.
...
- [ ] `Source Structure` is implemented inside the allowed AI worker paths.
...
TASK-004-ai-worker-settings-boundary.md
