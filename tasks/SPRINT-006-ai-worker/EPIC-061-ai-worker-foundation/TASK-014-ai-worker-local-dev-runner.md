...
# TASK-014 — Local Development Runner

## Summary

Create local development runner entrypoint without production deployment assumptions.
...
After this task is complete, Atlas Studio AI worker supports the **Local Development Runner** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Local Development Runner**.
...
- [ ] `Local Development Runner` is implemented inside the allowed AI worker paths.
...
TASK-015-ai-worker-test-fixtures.md
