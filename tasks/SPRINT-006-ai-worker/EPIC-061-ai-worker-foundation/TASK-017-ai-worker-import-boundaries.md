...
# TASK-017 — Import Boundaries

## Summary

Audit and enforce local import boundaries inside apps/ai-worker.
...
After this task is complete, Atlas Studio AI worker supports the **Import Boundaries** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Import Boundaries**.
...
- [ ] `Import Boundaries` is implemented inside the allowed AI worker paths.
...
TASK-018-ai-worker-foundation-public-boundary.md
