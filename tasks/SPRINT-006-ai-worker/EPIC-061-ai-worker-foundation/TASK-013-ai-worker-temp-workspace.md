...
# TASK-013 — Temporary Workspace

## Summary

Implement temporary workspace/path boundary for intermediate AI artifacts.
...
After this task is complete, Atlas Studio AI worker supports the **Temporary Workspace** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Temporary Workspace**.
...
- [ ] `Temporary Workspace` is implemented inside the allowed AI worker paths.
...
TASK-014-ai-worker-local-dev-runner.md
