...
# TASK-004 — Settings Boundary

## Summary

Implement typed settings/config loading boundary without committing real secrets.
...
After this task is complete, Atlas Studio AI worker supports the **Settings Boundary** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Settings Boundary**.
...
- [ ] `Settings Boundary` is implemented inside the allowed AI worker paths.
...
TASK-005-ai-worker-runtime-context.md
