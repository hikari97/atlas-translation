...
# TASK-008 — Error Model

## Summary

Implement typed error model and safe serialization for worker errors.
...
After this task is complete, Atlas Studio AI worker supports the **Error Model** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Error Model**.
...
- [ ] `Error Model` is implemented inside the allowed AI worker paths.
...
TASK-009-ai-worker-result-base.md
