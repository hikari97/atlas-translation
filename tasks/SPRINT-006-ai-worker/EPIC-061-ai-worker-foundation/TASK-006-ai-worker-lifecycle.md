...
Implement startup/shutdown lifecycle hooks without starting background jobs on import.
...
After this task is complete, Atlas Studio AI worker supports the **Lifecycle** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Lifecycle**.
...
- [ ] `Lifecycle` is implemented inside the allowed AI worker paths.
...
TASK-007-ai-worker-health-check.md
