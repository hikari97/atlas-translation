...
Add tests for settings, health, lifecycle, errors, and deterministic helpers.
...
After this task is complete, Atlas Studio AI worker supports the **Foundation Tests** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Foundation Tests**.
...
- [ ] `Foundation Tests` is implemented inside the allowed AI worker paths.
...
TASK-017-ai-worker-import-boundaries.md
