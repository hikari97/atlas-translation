...
# TASK-005 — Runtime Context

## Summary

Implement AI worker runtime context for settings, lifecycle, diagnostics, and dependency access.
...
After this task is complete, Atlas Studio AI worker supports the **Runtime Context** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Runtime Context**.
...
- [ ] `Runtime Context` is implemented inside the allowed AI worker paths.
...
TASK-006-ai-worker-lifecycle.md
