...
# TASK-011 — Clock And ID Helpers

## Summary

Implement deterministic clock and ID helper boundaries for tests and job metadata.
...
After this task is complete, Atlas Studio AI worker supports the **Clock And ID Helpers** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Clock And ID Helpers**.
...
- [ ] `Clock And ID Helpers` is implemented inside the allowed AI worker paths.
...
TASK-012-ai-worker-file-validation.md
