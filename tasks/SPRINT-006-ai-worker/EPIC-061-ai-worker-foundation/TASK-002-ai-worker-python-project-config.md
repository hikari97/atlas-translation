...
# TASK-002 — Python Project Config

## Summary

Define Python project metadata, dependency boundary, formatter/linter/test configuration, and local scripts.
...
After this task is complete, Atlas Studio AI worker supports the **Python Project Config** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Python Project Config**.
...
- [ ] `Python Project Config` is implemented inside the allowed AI worker paths.
...
TASK-003-ai-worker-source-structure.md
