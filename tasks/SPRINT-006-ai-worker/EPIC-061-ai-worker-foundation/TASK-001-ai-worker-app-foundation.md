---
id: TASK-001
title: AI Worker App Foundation
status: Ready
priority: High
story_points: 5
...
# TASK-001 — AI Worker App Foundation

## Summary

Create or normalize the apps/ai-worker application foundation and source layout.

This task belongs to **EPIC-061-ai-worker-foundation** and must be implemented only inside the allowed AI worker paths.

---

# Capability

After this task is complete, Atlas Studio AI worker supports the **AI Worker App Foundation** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **AI Worker App Foundation**.
...
- If the allowed app/package folder does not exist, create only the allowed folder structure needed for this task.
...
- [ ] `AI Worker App Foundation` is implemented inside the allowed AI worker paths.
...
TASK-002-ai-worker-python-project-config.md
