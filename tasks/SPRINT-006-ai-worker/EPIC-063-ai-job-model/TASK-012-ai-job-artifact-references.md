...
# TASK-012 — Artifact References

## Summary

Define input/output/intermediate artifact reference model for storage integration.
...
After this task is complete, Atlas Studio AI worker supports the **Artifact References** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Artifact References**.
...
- [ ] `Artifact References` is implemented inside the allowed AI worker paths.
...
TASK-013-ai-job-provider-metadata.md
