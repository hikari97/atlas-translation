...
# TASK-018 — AI Job Public API

## Summary

Finalize AI job model exports and stable contracts for later AI engine EPICs.
...
After this task is complete, Atlas Studio AI worker supports the **AI Job Public API** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **AI Job Public API**.
...
- [ ] `AI Job Public API` is implemented inside the allowed AI worker paths.
