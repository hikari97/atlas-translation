...
# TASK-017 — Job Model Tests

## Summary

Add tests for state transitions, validation, serialization, retry, and cancellation behavior.
...
After this task is complete, Atlas Studio AI worker supports the **Job Model Tests** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job Model Tests**.
...
- [ ] `Job Model Tests` is implemented inside the allowed AI worker paths.
