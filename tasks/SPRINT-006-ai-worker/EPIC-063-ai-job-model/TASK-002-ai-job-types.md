...
# TASK-002 — AI Job Types

## Summary

Define supported AI job types for OCR, bubble detection, classification, translation, QA, inpainting, rendering assistance, and pipeline jobs.
...
After this task is complete, Atlas Studio AI worker supports the **AI Job Types** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **AI Job Types**.
...
- [ ] `AI Job Types` is implemented inside the allowed AI worker paths.
