...
# TASK-008 — Job Error Contract

## Summary

Define job error codes, retryability, safe messages, and provider error wrapping boundaries.
...
After this task is complete, Atlas Studio AI worker supports the **Job Error Contract** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job Error Contract**.
...
- [ ] `Job Error Contract` is implemented inside the allowed AI worker paths.
...
TASK-009-ai-job-retry-metadata.md
