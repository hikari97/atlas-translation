...
# TASK-001 — AI Job Package Boundary

## Summary

Create shared AI job model boundary in apps/ai-worker and packages/atlas-ai where appropriate.
...
After this task is complete, Atlas Studio AI worker supports the **AI Job Package Boundary** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **AI Job Package Boundary**.
...
- [ ] `AI Job Package Boundary` is implemented inside the allowed AI worker paths.
