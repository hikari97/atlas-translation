...
# TASK-004 — Base Payload Model

## Summary

Define base payload metadata, source references, target references, language metadata, and options.
...
After this task is complete, Atlas Studio AI worker supports the **Base Payload Model** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Base Payload Model**.
...
- [ ] `Base Payload Model` is implemented inside the allowed AI worker paths.
...
TASK-005-ai-job-state-machine.md
