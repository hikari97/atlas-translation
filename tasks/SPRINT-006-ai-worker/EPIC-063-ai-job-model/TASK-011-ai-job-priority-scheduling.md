---
id: TASK-011
title: Priority Scheduling Metadata
status: Ready
priority: High
story_points: 5
...
# TASK-011 — Priority Scheduling Metadata

## Summary

Define priority, schedule-at, timeout, deadline, and execution policy metadata.
...
After this task is complete, Atlas Studio AI worker supports the **Priority Scheduling Metadata** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Priority Scheduling Metadata**.
...
- [ ] `Priority Scheduling Metadata` is implemented inside the allowed AI worker paths.
...
TASK-012-ai-job-artifact-references.md
