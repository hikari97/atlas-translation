...
# TASK-007 — Result Envelope

## Summary

Define normalized result envelope for success, partial success, failure, and cancelled jobs.
...
After this task is complete, Atlas Studio AI worker supports the **Result Envelope** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Result Envelope**.
...
- [ ] `Result Envelope` is implemented inside the allowed AI worker paths.
...
TASK-008-ai-job-error-contract.md
