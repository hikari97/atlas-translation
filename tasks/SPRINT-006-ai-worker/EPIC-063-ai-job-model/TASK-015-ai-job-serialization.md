...
# TASK-015 — Job Serialization

## Summary

Implement safe serialization/deserialization helpers for job payloads and results.
...
After this task is complete, Atlas Studio AI worker supports the **Job Serialization** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job Serialization**.
...
- [ ] `Job Serialization` is implemented inside the allowed AI worker paths.
...
TASK-016-ai-job-test-fixtures.md
