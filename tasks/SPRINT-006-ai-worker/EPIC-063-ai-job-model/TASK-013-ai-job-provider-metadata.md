...
# TASK-013 — Provider Metadata

## Summary

Define provider, model, version, cost, token, and timing metadata boundaries.
...
After this task is complete, Atlas Studio AI worker supports the **Provider Metadata** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Provider Metadata**.
...
- [ ] `Provider Metadata` is implemented inside the allowed AI worker paths.
