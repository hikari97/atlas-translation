...
# TASK-005 — Job State Machine

## Summary

Define lifecycle states and valid transitions for queued, running, succeeded, failed, cancelled, and retrying jobs.
...
After this task is complete, Atlas Studio AI worker supports the **Job State Machine** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job State Machine**.
...
- [ ] `Job State Machine` is implemented inside the allowed AI worker paths.
...
TASK-006-ai-job-progress-events.md
