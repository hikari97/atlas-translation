...
# TASK-006 — Progress Events

## Summary

Define progress event model, step metadata, percentages, messages, and timestamps.
...
After this task is complete, Atlas Studio AI worker supports the **Progress Events** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Progress Events**.
...
- [ ] `Progress Events` is implemented inside the allowed AI worker paths.
...
TASK-007-ai-job-result-envelope.md
