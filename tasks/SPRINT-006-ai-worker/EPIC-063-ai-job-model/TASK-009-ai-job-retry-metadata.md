...
# TASK-009 — Retry Metadata

## Summary

Define retry attempt metadata, backoff hints, max retry policies, and retry decision helpers.
...
After this task is complete, Atlas Studio AI worker supports the **Retry Metadata** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Retry Metadata**.
...
- [ ] `Retry Metadata` is implemented inside the allowed AI worker paths.
...
TASK-010-ai-job-cancellation.md
