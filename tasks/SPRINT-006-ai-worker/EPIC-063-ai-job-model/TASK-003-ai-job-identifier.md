...
# TASK-003 — AI Job Identifier

## Summary

Implement job ID, correlation ID, trace ID, and idempotency key contracts.
...
After this task is complete, Atlas Studio AI worker supports the **AI Job Identifier** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **AI Job Identifier**.
...
- [ ] `AI Job Identifier` is implemented inside the allowed AI worker paths.
...
TASK-004-ai-job-payload-base.md
