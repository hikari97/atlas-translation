...
# TASK-014 — Job Validation

## Summary

Implement validation helpers for job type, payload, state transition, and result envelope.
...
After this task is complete, Atlas Studio AI worker supports the **Job Validation** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job Validation**.
...
- [ ] `Job Validation` is implemented inside the allowed AI worker paths.
...
TASK-015-ai-job-serialization.md
