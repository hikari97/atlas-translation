...
# TASK-005 — Response Models

## Summary

Define typed response models for job accepted, status, result, errors, and diagnostics.
...
After this task is complete, Atlas Studio AI worker supports the **Response Models** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Response Models**.
...
- [ ] `Response Models` is implemented inside the allowed AI worker paths.
...
TASK-006-ai-worker-api-error-handling.md
