...
# TASK-015 — OpenAPI Metadata

## Summary

Define API title, version, tags, and schema metadata for AI worker routes.
...
After this task is complete, Atlas Studio AI worker supports the **OpenAPI Metadata** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **OpenAPI Metadata**.
...
- [ ] `OpenAPI Metadata` is implemented inside the allowed AI worker paths.
...
TASK-016-ai-worker-api-tests.md
