...
# TASK-003 — Health Routes

## Summary

Implement health and readiness HTTP routes using foundation health contracts.
...
After this task is complete, Atlas Studio AI worker supports the **Health Routes** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Health Routes**.
...
- [ ] `Health Routes` is implemented inside the allowed AI worker paths.
...
TASK-004-ai-worker-api-request-models.md
