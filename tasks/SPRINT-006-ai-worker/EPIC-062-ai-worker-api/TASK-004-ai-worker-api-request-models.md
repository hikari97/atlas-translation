...
# TASK-004 — Request Models

## Summary

Define typed request models for job submission and control operations.
...
After this task is complete, Atlas Studio AI worker supports the **Request Models** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Request Models**.
...
- [ ] `Request Models` is implemented inside the allowed AI worker paths.
...
TASK-005-ai-worker-api-response-models.md
