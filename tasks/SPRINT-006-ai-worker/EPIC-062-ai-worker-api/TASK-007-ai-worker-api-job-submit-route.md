...
# TASK-007 — Job Submit Route

## Summary

Implement job submission route boundary without executing provider-backed AI work.
...
After this task is complete, Atlas Studio AI worker supports the **Job Submit Route** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job Submit Route**.
...
- [ ] `Job Submit Route` is implemented inside the allowed AI worker paths.
...
TASK-008-ai-worker-api-job-status-route.md
