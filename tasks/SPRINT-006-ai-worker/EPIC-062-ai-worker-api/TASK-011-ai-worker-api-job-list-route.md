...
# TASK-011 — Job List Route

## Summary

Implement job listing route boundary with filtering/pagination contracts.
...
After this task is complete, Atlas Studio AI worker supports the **Job List Route** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **Job List Route**.
...
- [ ] `Job List Route` is implemented inside the allowed AI worker paths.
...
TASK-012-ai-worker-api-diagnostics-route.md
