...
# TASK-017 — API Client Contract

## Summary

Document and expose stable API response contracts for backend consumers.
...
After this task is complete, Atlas Studio AI worker supports the **API Client Contract** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **API Client Contract**.
...
- [ ] `API Client Contract` is implemented inside the allowed AI worker paths.
...
TASK-018-ai-worker-api-public-boundary.md
