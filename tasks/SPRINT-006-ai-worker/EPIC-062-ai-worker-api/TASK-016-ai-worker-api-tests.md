...
Add tests for health, job submit/status/result/cancel, validation, and error responses.
...
After this task is complete, Atlas Studio AI worker supports the **API Tests** capability.

---

# Goal

Implement the smallest production-quality AI worker increment needed for **API Tests**.
...
- [ ] `API Tests` is implemented inside the allowed AI worker paths.
...
TASK-017-ai-worker-api-client-contract.md
