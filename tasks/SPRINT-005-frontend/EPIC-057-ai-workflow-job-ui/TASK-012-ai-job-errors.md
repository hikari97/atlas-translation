...
# TASK-012 — Job Error States

## Summary

Implement job failure, partial failure, and retryable error UI.
...
After this task is complete, Atlas Studio frontend supports the **Job Error States** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Error States**.
...
- [x] `Job Error States` is implemented inside the allowed frontend paths.
