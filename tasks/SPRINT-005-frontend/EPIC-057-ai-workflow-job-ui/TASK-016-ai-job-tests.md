...
# TASK-016 — AI Job Tests

## Summary

Add tests for job list, detail, actions, and error states.
...
After this task is complete, Atlas Studio frontend supports the **AI Job Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **AI Job Tests**.
...
- [x] `AI Job Tests` is implemented inside the allowed frontend paths.
...
TASK-017-ai-job-accessibility.md
