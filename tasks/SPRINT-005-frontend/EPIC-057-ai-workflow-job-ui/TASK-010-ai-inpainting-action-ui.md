...
# TASK-010 — Inpainting Action UI

## Summary

Implement inpainting job entry points from image tools.
...
After this task is complete, Atlas Studio frontend supports the **Inpainting Action UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Inpainting Action UI**.
...
- [x] `Inpainting Action UI` is implemented inside the allowed frontend paths.
