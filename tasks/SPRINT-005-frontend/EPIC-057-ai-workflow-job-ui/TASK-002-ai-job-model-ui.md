...
# TASK-002 — AI Job Model UI

## Summary

Define frontend job display model for OCR, translation, review, export, and inpainting.
...
After this task is complete, Atlas Studio frontend supports the **AI Job Model UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **AI Job Model UI**.
...
- [x] `AI Job Model UI` is implemented inside the allowed frontend paths.
