...
# TASK-006 — Job Actions

## Summary

Implement start, cancel, retry, pause/resume placeholder actions.
...
After this task is complete, Atlas Studio frontend supports the **Job Actions** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Actions**.
...
- [x] `Job Actions` is implemented inside the allowed frontend paths.
