...
Implement structured log display UI.
...
After this task is complete, Atlas Studio frontend supports the **Job Logs** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Logs**.
...
- [x] `Job Logs` is implemented inside the allowed frontend paths.
