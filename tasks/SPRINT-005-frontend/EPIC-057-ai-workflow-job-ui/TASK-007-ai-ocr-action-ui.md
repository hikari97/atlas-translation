...
# TASK-007 — OCR Action UI

## Summary

Implement OCR action entry points for selected pages/bubbles.
...
After this task is complete, Atlas Studio frontend supports the **OCR Action UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **OCR Action UI**.
...
- [x] `OCR Action UI` is implemented inside the allowed frontend paths.
...
TASK-008-ai-translation-action-ui.md
