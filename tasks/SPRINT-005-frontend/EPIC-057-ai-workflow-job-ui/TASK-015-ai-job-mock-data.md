...
# TASK-015 — Job Mock Data

## Summary

Add deterministic AI job fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Job Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Mock Data**.
...
- [x] `Job Mock Data` is implemented inside the allowed frontend paths.
