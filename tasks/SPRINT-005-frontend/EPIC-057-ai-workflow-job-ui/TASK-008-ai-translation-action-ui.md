...
# TASK-008 — Translation Action UI

## Summary

Implement translation action entry points for selected text/pages.
...
After this task is complete, Atlas Studio frontend supports the **Translation Action UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Translation Action UI**.
...
- [x] `Translation Action UI` is implemented inside the allowed frontend paths.
...
TASK-009-ai-review-action-ui.md
