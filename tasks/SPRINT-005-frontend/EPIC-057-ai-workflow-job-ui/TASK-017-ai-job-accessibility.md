...
# TASK-017 — AI Job Accessibility

## Summary

Ensure progress, logs, and controls are accessible.
...
After this task is complete, Atlas Studio frontend supports the **AI Job Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **AI Job Accessibility**.
...
- [x] `AI Job Accessibility` is implemented inside the allowed frontend paths.
...
TASK-018-ai-job-public-boundary.md
