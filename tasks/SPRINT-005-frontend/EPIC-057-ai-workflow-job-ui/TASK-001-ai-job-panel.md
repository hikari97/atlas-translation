...
# TASK-001 — AI Job Panel

## Summary

Create AI workflow/job panel boundary.
...
After this task is complete, Atlas Studio frontend supports the **AI Job Panel** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **AI Job Panel**.
...
- [x] `AI Job Panel` is implemented inside the allowed frontend paths.
