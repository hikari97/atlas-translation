...
# TASK-013 — Job Data Hooks

## Summary

Integrate job UI with frontend data access and mock adapters.
...
After this task is complete, Atlas Studio frontend supports the **Job Data Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Data Hooks**.
...
- [x] `Job Data Hooks` is implemented inside the allowed frontend paths.
...
TASK-014-ai-job-notifications.md
