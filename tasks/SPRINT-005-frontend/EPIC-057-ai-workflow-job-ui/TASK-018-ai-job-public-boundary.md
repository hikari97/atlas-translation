...
# TASK-018 — AI Job Public Boundary

## Summary

Finalize AI workflow job feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **AI Job Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **AI Job Public Boundary**.
...
- [x] `AI Job Public Boundary` is implemented inside the allowed frontend paths.
