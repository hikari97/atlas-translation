...
Implement job detail drawer/panel with logs and metadata.
...
After this task is complete, Atlas Studio frontend supports the **Job Detail** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Detail**.
...
- [x] `Job Detail` is implemented inside the allowed frontend paths.
