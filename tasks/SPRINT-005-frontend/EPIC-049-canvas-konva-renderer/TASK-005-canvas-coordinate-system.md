...
# TASK-005 — Coordinate System

## Summary

Implement conversion between screen, stage, page, and normalized coordinates.
...
After this task is complete, Atlas Studio frontend supports the **Coordinate System** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Coordinate System**.
...
- [x] `Coordinate System` is implemented inside the allowed frontend paths.
...
TASK-006-canvas-bubble-rendering.md
