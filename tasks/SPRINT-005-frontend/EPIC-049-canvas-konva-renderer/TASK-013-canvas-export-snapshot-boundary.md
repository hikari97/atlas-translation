...
# TASK-013 — Snapshot Boundary

## Summary

Define frontend snapshot/render capture boundary without final export pipeline.
...
After this task is complete, Atlas Studio frontend supports the **Snapshot Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Snapshot Boundary**.
...
- [x] `Snapshot Boundary` is implemented inside the allowed frontend paths.
...
TASK-014-canvas-error-boundary.md
