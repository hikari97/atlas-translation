...
# TASK-004 — Viewport Transform

## Summary

Implement zoom, pan, fit-to-screen, and reset viewport controls.
...
After this task is complete, Atlas Studio frontend supports the **Viewport Transform** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Viewport Transform**.
...
- [x] `Viewport Transform` is implemented inside the allowed frontend paths.
...
TASK-005-canvas-coordinate-system.md
