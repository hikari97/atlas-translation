...
# TASK-011 — Grid Guides

## Summary

Implement optional grid, guides, and alignment overlay rendering.
...
After this task is complete, Atlas Studio frontend supports the **Grid Guides** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Grid Guides**.
...
- [x] `Grid Guides` is implemented inside the allowed frontend paths.
...
TASK-012-canvas-performance-boundary.md
