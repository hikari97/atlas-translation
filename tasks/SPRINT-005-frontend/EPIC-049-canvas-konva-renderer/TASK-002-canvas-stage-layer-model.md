...
# TASK-002 — Stage Layer Model

## Summary

Define canvas stage/layer model for background, artwork, bubbles, text, selections, and overlays.
...
After this task is complete, Atlas Studio frontend supports the **Stage Layer Model** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Stage Layer Model**.
...
- [x] `Stage Layer Model` is implemented inside the allowed frontend paths.
...
TASK-003-canvas-image-rendering.md
