...
# TASK-001 — Konva Canvas Foundation

## Summary

Create Konva canvas component boundary and lazy-safe rendering setup.

This task belongs to **EPIC-049-canvas-konva-renderer** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Konva Canvas Foundation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Konva Canvas Foundation**.
...
- [x] `Konva Canvas Foundation` is implemented inside the allowed frontend paths.
...
TASK-002-canvas-stage-layer-model.md
