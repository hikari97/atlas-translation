...
# TASK-017 — Canvas Accessibility

## Summary

Provide accessible labels and keyboard-accessible object navigation boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Canvas Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Canvas Accessibility**.
...
- [x] `Canvas Accessibility` is implemented inside the allowed frontend paths.
...
TASK-018-canvas-public-boundary.md
