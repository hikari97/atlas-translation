...
# TASK-015 — Canvas Mock Fixtures

## Summary

Add mock page/canvas fixtures for tests and development.
...
After this task is complete, Atlas Studio frontend supports the **Canvas Mock Fixtures** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Canvas Mock Fixtures**.
...
- [x] `Canvas Mock Fixtures` is implemented inside the allowed frontend paths.
