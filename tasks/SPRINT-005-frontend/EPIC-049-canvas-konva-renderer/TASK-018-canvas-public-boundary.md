...
# TASK-018 — Canvas Public Boundary

## Summary

Finalize canvas renderer exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Canvas Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Canvas Public Boundary**.
...
- [x] `Canvas Public Boundary` is implemented inside the allowed frontend paths.
