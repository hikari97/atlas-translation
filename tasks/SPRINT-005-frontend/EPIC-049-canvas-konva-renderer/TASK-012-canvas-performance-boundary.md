...
# TASK-012 — Performance Boundary

## Summary

Add memoization and render boundary rules for large pages.
...
After this task is complete, Atlas Studio frontend supports the **Performance Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Performance Boundary**.
...
- [x] `Performance Boundary` is implemented inside the allowed frontend paths.
...
TASK-013-canvas-export-snapshot-boundary.md
