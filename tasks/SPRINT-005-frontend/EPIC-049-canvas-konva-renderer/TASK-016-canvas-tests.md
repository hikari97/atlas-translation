...
# TASK-016 — Canvas Tests

## Summary

Add tests for coordinate transforms, hit testing, and render boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Canvas Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Canvas Tests**.
...
- [x] `Canvas Tests` is implemented inside the allowed frontend paths.
...
TASK-017-canvas-accessibility.md
