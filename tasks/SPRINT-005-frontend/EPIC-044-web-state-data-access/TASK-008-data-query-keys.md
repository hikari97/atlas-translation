...
# TASK-008 — Data Query Keys

## Summary

Define stable query key helpers for frontend data fetching.
...
After this task is complete, Atlas Studio frontend supports the **Data Query Keys** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Data Query Keys**.
...
- [x] `Data Query Keys` is implemented inside the allowed frontend paths.
