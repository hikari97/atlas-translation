...
# TASK-009 — Fetch Hooks

## Summary

Implement typed data fetching hooks for workspace and project placeholder APIs.
...
After this task is complete, Atlas Studio frontend supports the **Fetch Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Fetch Hooks**.
...
- [x] `Fetch Hooks` is implemented inside the allowed frontend paths.
...
TASK-010-data-mutation-hooks.md
