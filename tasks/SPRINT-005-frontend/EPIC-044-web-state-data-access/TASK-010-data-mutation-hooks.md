...
# TASK-010 — Mutation Hooks

## Summary

Implement typed mutation hook boundaries for create/update/delete flows.
...
After this task is complete, Atlas Studio frontend supports the **Mutation Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Mutation Hooks**.
...
- [x] `Mutation Hooks` is implemented inside the allowed frontend paths.
...
TASK-011-data-error-normalization.md
