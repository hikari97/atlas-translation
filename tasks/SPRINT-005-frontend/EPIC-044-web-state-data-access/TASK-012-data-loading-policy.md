...
# TASK-012 — Loading Policy

## Summary

Define loading, optimistic, stale, and refetch behavior contracts.
...
After this task is complete, Atlas Studio frontend supports the **Loading Policy** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Loading Policy**.
...
- [x] `Loading Policy` is implemented inside the allowed frontend paths.
