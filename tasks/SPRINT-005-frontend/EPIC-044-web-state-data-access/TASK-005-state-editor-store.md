...
# TASK-005 — Editor Store

## Summary

Implement editor-local state boundaries for page, selection, viewport, and panels.
...
After this task is complete, Atlas Studio frontend supports the **Editor Store** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Store**.
...
- [x] `Editor Store` is implemented inside the allowed frontend paths.
