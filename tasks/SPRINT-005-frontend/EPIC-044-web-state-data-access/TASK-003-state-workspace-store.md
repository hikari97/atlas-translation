...
# TASK-003 — Workspace Store

## Summary

Implement workspace selection and workspace UI state.
...
After this task is complete, Atlas Studio frontend supports the **Workspace Store** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Workspace Store**.
...
- [x] `Workspace Store` is implemented inside the allowed frontend paths.
...
TASK-004-state-project-store.md
