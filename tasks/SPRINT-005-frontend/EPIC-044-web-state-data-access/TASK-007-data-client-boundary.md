...
# TASK-007 — Data Client Boundary

## Summary

Implement typed API client boundary without hardcoding final backend routes.
...
After this task is complete, Atlas Studio frontend supports the **Data Client Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Data Client Boundary**.
...
- [x] `Data Client Boundary` is implemented inside the allowed frontend paths.
