...
Ensure state/data-access imports do not leak into UI packages improperly.
...
After this task is complete, Atlas Studio frontend supports the **Import Boundaries** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Import Boundaries**.
...
- [x] `Import Boundaries` is implemented inside the allowed frontend paths.
...
TASK-018-state-public-boundary.md
