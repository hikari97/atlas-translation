...
Implement app-level state store boundary for UI preferences and session-independent state.
...
After this task is complete, Atlas Studio frontend supports the **App Store** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **App Store**.
...
- [x] `App Store` is implemented inside the allowed frontend paths.
...
TASK-003-state-workspace-store.md
