...
Implement frontend job state for OCR, translation, export, and AI workflow displays.
...
After this task is complete, Atlas Studio frontend supports the **Job Store** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Store**.
...
- [x] `Job Store` is implemented inside the allowed frontend paths.
...
TASK-007-data-client-boundary.md
