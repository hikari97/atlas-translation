...
# TASK-014 — Mock Data Adapters

## Summary

Create deterministic mock adapters for tests and disconnected UI development.
...
After this task is complete, Atlas Studio frontend supports the **Mock Data Adapters** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Mock Data Adapters**.
...
- [x] `Mock Data Adapters` is implemented inside the allowed frontend paths.
