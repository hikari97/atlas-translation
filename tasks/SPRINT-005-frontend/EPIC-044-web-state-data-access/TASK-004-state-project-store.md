...
# TASK-004 — Project Store

## Summary

Implement project selection and project UI state.
...
After this task is complete, Atlas Studio frontend supports the **Project Store** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Project Store**.
...
- [x] `Project Store` is implemented inside the allowed frontend paths.
...
TASK-005-state-editor-store.md
