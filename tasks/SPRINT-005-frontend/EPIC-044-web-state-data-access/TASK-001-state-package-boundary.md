...
# TASK-001 — State Boundary

## Summary

Create frontend-local state and data access structure.

This task belongs to **EPIC-044-web-state-data-access** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **State Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **State Boundary**.
...
- [x] `State Boundary` is implemented inside the allowed frontend paths.
