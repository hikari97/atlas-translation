...
# TASK-014 — Danger Zone

## Summary

Implement destructive action confirmation UI boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Danger Zone** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Danger Zone**.
...
- [x] `Danger Zone` is implemented inside the allowed frontend paths.
...
TASK-015-settings-data-hooks.md
