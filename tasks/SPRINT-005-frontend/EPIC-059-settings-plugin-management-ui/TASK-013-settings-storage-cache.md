...
# TASK-013 — Storage Cache Settings

## Summary

Implement frontend settings UI for local storage/cache preferences.
...
After this task is complete, Atlas Studio frontend supports the **Storage Cache Settings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Storage Cache Settings**.
...
- [x] `Storage Cache Settings` is implemented inside the allowed frontend paths.
...
TASK-014-settings-danger-zone.md
