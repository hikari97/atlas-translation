...
# TASK-010 — Plugin List

## Summary

Implement plugin list UI with status, version, and capability badges.
...
After this task is complete, Atlas Studio frontend supports the **Plugin List** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Plugin List**.
...
- [x] `Plugin List` is implemented inside the allowed frontend paths.
...
TASK-011-settings-plugin-detail.md
