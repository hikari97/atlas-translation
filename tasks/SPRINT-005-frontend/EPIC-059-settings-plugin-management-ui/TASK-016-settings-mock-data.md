...
# TASK-016 — Settings Mock Data

## Summary

Add deterministic settings and plugin fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Settings Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Settings Mock Data**.
...
- [x] `Settings Mock Data` is implemented inside the allowed frontend paths.
