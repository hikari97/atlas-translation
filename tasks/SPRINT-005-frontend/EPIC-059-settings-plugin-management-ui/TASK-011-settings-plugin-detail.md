...
# TASK-011 — Plugin Detail

## Summary

Implement plugin detail view and capability inspection.
...
After this task is complete, Atlas Studio frontend supports the **Plugin Detail** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Plugin Detail**.
...
- [x] `Plugin Detail` is implemented inside the allowed frontend paths.
...
TASK-012-settings-plugin-enable-disable.md
