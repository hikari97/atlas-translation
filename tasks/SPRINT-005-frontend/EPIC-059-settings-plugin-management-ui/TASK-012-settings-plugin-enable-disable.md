...
# TASK-012 — Plugin Enable Disable

## Summary

Implement enable/disable UI boundary without runtime plugin loading.
...
After this task is complete, Atlas Studio frontend supports the **Plugin Enable Disable** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Plugin Enable Disable**.
...
- [x] `Plugin Enable Disable` is implemented inside the allowed frontend paths.
...
TASK-013-settings-storage-cache.md
