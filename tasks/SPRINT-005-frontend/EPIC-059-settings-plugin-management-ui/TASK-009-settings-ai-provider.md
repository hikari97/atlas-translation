...
# TASK-009 — AI Provider Settings

## Summary

Implement provider settings UI boundary without storing secrets unsafely.
...
After this task is complete, Atlas Studio frontend supports the **AI Provider Settings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **AI Provider Settings**.
...
- [x] `AI Provider Settings` is implemented inside the allowed frontend paths.
...
TASK-010-settings-plugin-list.md
