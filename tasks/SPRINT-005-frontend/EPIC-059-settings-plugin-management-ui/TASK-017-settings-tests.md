...
# TASK-017 — Settings UI Tests

## Summary

Add tests for settings forms, plugin list, and validation states.
...
After this task is complete, Atlas Studio frontend supports the **Settings UI Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Settings UI Tests**.
...
- [x] `Settings UI Tests` is implemented inside the allowed frontend paths.
...
TASK-018-settings-public-boundary.md
