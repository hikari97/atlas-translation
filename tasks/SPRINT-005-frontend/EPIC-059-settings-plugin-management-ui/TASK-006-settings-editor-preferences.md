...
# TASK-006 — Editor Preferences

## Summary

Implement editor preferences for theme, zoom, panels, and tool defaults.
...
After this task is complete, Atlas Studio frontend supports the **Editor Preferences** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Preferences**.
...
- [x] `Editor Preferences` is implemented inside the allowed frontend paths.
...
TASK-007-settings-shortcuts.md
