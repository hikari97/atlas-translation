...
# TASK-004 — Workspace Settings

## Summary

Implement workspace settings UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Workspace Settings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Workspace Settings**.
...
- [x] `Workspace Settings` is implemented inside the allowed frontend paths.
...
TASK-005-settings-project-defaults.md
