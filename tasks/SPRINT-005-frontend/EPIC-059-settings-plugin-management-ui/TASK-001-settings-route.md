...
# TASK-001 — Settings Route

## Summary

Create settings route structure and shell integration.

This task belongs to **EPIC-059-settings-plugin-management-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Settings Route** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Settings Route**.
...
- [x] `Settings Route` is implemented inside the allowed frontend paths.
