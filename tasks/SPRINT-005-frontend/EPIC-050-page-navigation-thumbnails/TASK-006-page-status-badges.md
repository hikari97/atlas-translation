...
# TASK-006 — Page Status Badges

## Summary

Implement status badges for imported, OCR, translated, reviewed, and exported states.
...
After this task is complete, Atlas Studio frontend supports the **Page Status Badges** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Status Badges**.
...
- [x] `Page Status Badges` is implemented inside the allowed frontend paths.
