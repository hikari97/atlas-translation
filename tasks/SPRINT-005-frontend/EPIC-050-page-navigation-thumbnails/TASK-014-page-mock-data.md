...
# TASK-014 — Page Mock Data

## Summary

Add deterministic page and thumbnail fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Page Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Mock Data**.
...
- [x] `Page Mock Data` is implemented inside the allowed frontend paths.
