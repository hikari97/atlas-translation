...
# TASK-008 — Page Context Menu

## Summary

Implement page context menu actions boundary.
...
After this task is complete, Atlas Studio frontend supports the **Page Context Menu** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Context Menu**.
...
- [x] `Page Context Menu` is implemented inside the allowed frontend paths.
