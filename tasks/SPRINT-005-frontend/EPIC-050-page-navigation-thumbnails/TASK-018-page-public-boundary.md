...
# TASK-018 — Page Public Boundary

## Summary

Finalize page navigation exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Page Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Public Boundary**.
...
- [x] `Page Public Boundary` is implemented inside the allowed frontend paths.
