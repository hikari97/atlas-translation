...
# TASK-010 — Page Bulk Selection

## Summary

Implement bulk page selection UI.
...
After this task is complete, Atlas Studio frontend supports the **Page Bulk Selection** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Bulk Selection**.
...
- [x] `Page Bulk Selection` is implemented inside the allowed frontend paths.
...
TASK-011-page-loading-error.md
