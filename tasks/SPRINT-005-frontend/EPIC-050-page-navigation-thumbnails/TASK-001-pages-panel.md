...
# TASK-001 — Pages Panel

## Summary

Create pages panel inside editor left panel.

This task belongs to **EPIC-050-page-navigation-thumbnails** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Pages Panel** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Pages Panel**.
...
- [x] `Pages Panel` is implemented inside the allowed frontend paths.
...
TASK-002-page-thumbnail-card.md
