...
# TASK-017 — Typography Accessibility

## Summary

Ensure controls are labelled and keyboard accessible.
...
After this task is complete, Atlas Studio frontend supports the **Typography Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Typography Accessibility**.
...
- [x] `Typography Accessibility` is implemented inside the allowed frontend paths.
...
TASK-018-typography-public-boundary.md
