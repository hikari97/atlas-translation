...
# TASK-012 — Style Preview

## Summary

Implement live style preview integration with canvas text rendering.
...
After this task is complete, Atlas Studio frontend supports the **Style Preview** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Style Preview**.
...
- [x] `Style Preview` is implemented inside the allowed frontend paths.
...
TASK-013-typography-batch-apply.md
