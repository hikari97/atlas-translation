...
# TASK-008 — Shadow Controls

## Summary

Implement shadow controls and preview state.
...
After this task is complete, Atlas Studio frontend supports the **Shadow Controls** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shadow Controls**.
...
- [x] `Shadow Controls` is implemented inside the allowed frontend paths.
...
TASK-009-typography-spacing.md
