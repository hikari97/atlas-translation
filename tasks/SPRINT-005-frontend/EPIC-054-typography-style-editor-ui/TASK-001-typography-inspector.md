...
# TASK-001 — Typography Inspector

## Summary

Create typography inspector panel for selected text objects.

This task belongs to **EPIC-054-typography-style-editor-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Typography Inspector** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Typography Inspector**.
...
- [x] `Typography Inspector` is implemented inside the allowed frontend paths.
...
TASK-002-typography-font-family.md
