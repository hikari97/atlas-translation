...
# TASK-006 — Text Direction Controls

## Summary

Implement horizontal/vertical/RTL direction controls.
...
After this task is complete, Atlas Studio frontend supports the **Text Direction Controls** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Text Direction Controls**.
...
- [x] `Text Direction Controls` is implemented inside the allowed frontend paths.
...
TASK-007-typography-stroke-fill.md
