...
# TASK-002 — Font Family Control

## Summary

Implement font family selection UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Font Family Control** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Font Family Control**.
...
- [x] `Font Family Control` is implemented inside the allowed frontend paths.
...
TASK-003-typography-font-size.md
