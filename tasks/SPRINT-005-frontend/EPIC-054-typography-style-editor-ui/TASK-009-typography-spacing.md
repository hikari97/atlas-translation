...
# TASK-009 — Spacing Controls

## Summary

Implement letter spacing, word spacing, and paragraph spacing controls.
...
After this task is complete, Atlas Studio frontend supports the **Spacing Controls** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Spacing Controls**.
...
- [x] `Spacing Controls` is implemented inside the allowed frontend paths.
...
TASK-010-typography-box-fit.md
