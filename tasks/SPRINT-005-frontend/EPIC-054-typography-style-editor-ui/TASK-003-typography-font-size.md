...
# TASK-003 — Font Size Control

## Summary

Implement font size and line-height controls.
...
After this task is complete, Atlas Studio frontend supports the **Font Size Control** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Font Size Control**.
...
- [x] `Font Size Control` is implemented inside the allowed frontend paths.
...
TASK-004-typography-weight-style.md
