...
# TASK-004 — Weight Style Controls

## Summary

Implement weight, italic, underline, and casing controls.
...
After this task is complete, Atlas Studio frontend supports the **Weight Style Controls** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Weight Style Controls**.
...
- [x] `Weight Style Controls` is implemented inside the allowed frontend paths.
...
TASK-005-typography-alignment.md
