...
# TASK-013 — Batch Apply

## Summary

Implement batch style apply UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Batch Apply** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Batch Apply**.
...
- [x] `Batch Apply` is implemented inside the allowed frontend paths.
...
TASK-014-typography-state-integration.md
