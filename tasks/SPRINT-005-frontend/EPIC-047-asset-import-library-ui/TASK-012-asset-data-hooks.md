...
# TASK-012 — Asset Data Hooks

## Summary

Integrate asset UI with frontend data access boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Asset Data Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Asset Data Hooks**.
...
- [x] `Asset Data Hooks` is implemented inside the allowed frontend paths.
