...
# TASK-010 — Bulk Actions

## Summary

Implement select, reorder, remove, and status update bulk UI.
...
After this task is complete, Atlas Studio frontend supports the **Bulk Actions** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bulk Actions**.
...
- [x] `Bulk Actions` is implemented inside the allowed frontend paths.
...
TASK-011-asset-empty-error-states.md
