...
# TASK-013 — Asset Mock Data

## Summary

Add deterministic mock asset data and file fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Asset Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Asset Mock Data**.
...
- [x] `Asset Mock Data` is implemented inside the allowed frontend paths.
...
TASK-014-asset-image-loading.md
