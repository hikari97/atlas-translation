...
After this task is complete, Atlas Studio frontend supports the **Page Ordering** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Ordering**.
...
- [x] `Page Ordering` is implemented inside the allowed frontend paths.
...
TASK-007-asset-page-metadata.md
