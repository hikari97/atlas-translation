...
# TASK-015 — Asset UI Tests

## Summary

Add upload UI, ordering, and library component tests.
...
After this task is complete, Atlas Studio frontend supports the **Asset UI Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Asset UI Tests**.
...
- [x] `Asset UI Tests` is implemented inside the allowed frontend paths.
...
TASK-016-asset-accessibility.md
