...
# TASK-002 — Upload Dropzone

## Summary

Implement drag/drop and file picker UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Upload Dropzone** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Upload Dropzone**.
...
- [x] `Upload Dropzone` is implemented inside the allowed frontend paths.
...
TASK-003-asset-file-validation.md
