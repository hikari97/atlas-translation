...
# TASK-016 — Asset Accessibility

## Summary

Ensure file input, keyboard selection, and action menus are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Asset Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Asset Accessibility**.
...
- [x] `Asset Accessibility` is implemented inside the allowed frontend paths.
