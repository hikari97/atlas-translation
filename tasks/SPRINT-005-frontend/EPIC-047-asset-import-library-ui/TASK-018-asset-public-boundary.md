...
# TASK-018 — Asset Public Boundary

## Summary

Finalize asset feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Asset Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Asset Public Boundary**.
...
- [x] `Asset Public Boundary` is implemented inside the allowed frontend paths.
