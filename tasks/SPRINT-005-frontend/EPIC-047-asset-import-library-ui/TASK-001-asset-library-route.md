...
# TASK-001 — Asset Library Route

## Summary

Create asset library route and project integration.

This task belongs to **EPIC-047-asset-import-library-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Asset Library Route** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Asset Library Route**.
...
- [x] `Asset Library Route` is implemented inside the allowed frontend paths.
...
TASK-002-asset-upload-dropzone.md
