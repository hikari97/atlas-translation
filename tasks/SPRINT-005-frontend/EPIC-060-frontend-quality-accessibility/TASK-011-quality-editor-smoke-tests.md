...
# TASK-011 — Editor Smoke Tests

## Summary

Add editor smoke tests for loading, canvas, selection, panels, and text editor surfaces.
...
After this task is complete, Atlas Studio frontend supports the **Editor Smoke Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Smoke Tests**.
...
- [x] `Editor Smoke Tests` is implemented inside the allowed frontend paths.
...
TASK-012-quality-dashboard-smoke-tests.md
