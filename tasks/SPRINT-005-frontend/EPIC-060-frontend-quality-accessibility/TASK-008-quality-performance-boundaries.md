...
# TASK-008 — Performance Boundaries

## Summary

Add frontend performance guardrails for large editor documents.
...
After this task is complete, Atlas Studio frontend supports the **Performance Boundaries** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Performance Boundaries**.
...
- [x] `Performance Boundaries` is implemented inside the allowed frontend paths.
...
TASK-009-quality-bundle-boundary.md
