...
# TASK-015 — Shortcuts Help

## Summary

Add keyboard shortcut discoverability/help UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Shortcuts Help** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shortcuts Help**.
...
- [x] `Shortcuts Help` is implemented inside the allowed frontend paths.
...
TASK-016-quality-no-mock-leak.md
