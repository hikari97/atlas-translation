...
# TASK-002 — Landmarks Headings

## Summary

Validate and fix landmarks, headings, labels, and page structure.
...
After this task is complete, Atlas Studio frontend supports the **Landmarks Headings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Landmarks Headings**.
...
- [x] `Landmarks Headings` is implemented inside the allowed frontend paths.
...
TASK-003-quality-keyboard-navigation.md
