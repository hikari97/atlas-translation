...
# TASK-012 — Dashboard Smoke Tests

## Summary

Add dashboard/project/settings smoke tests.
...
After this task is complete, Atlas Studio frontend supports the **Dashboard Smoke Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Dashboard Smoke Tests**.
...
- [x] `Dashboard Smoke Tests` is implemented inside the allowed frontend paths.
...
TASK-013-quality-error-boundaries.md
