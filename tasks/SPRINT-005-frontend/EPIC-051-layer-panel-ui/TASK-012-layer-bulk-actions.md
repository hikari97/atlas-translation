...
# TASK-012 — Layer Bulk Actions

## Summary

Implement bulk visibility/lock/delete action UI boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Layer Bulk Actions** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Bulk Actions**.
...
- [x] `Layer Bulk Actions` is implemented inside the allowed frontend paths.
...
TASK-013-layer-state-integration.md
