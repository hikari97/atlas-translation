...
# TASK-018 — Layer Public Boundary

## Summary

Finalize layer feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Layer Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Public Boundary**.
...
- [x] `Layer Public Boundary` is implemented inside the allowed frontend paths.
