...
# TASK-016 — Layer Accessibility

## Summary

Ensure layer tree roles, labels, and keyboard interaction are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Layer Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Accessibility**.
...
- [x] `Layer Accessibility` is implemented inside the allowed frontend paths.
