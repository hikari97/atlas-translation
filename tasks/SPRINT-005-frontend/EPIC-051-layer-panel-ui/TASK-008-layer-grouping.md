...
# TASK-008 — Layer Grouping

## Summary

Implement group display and nested layer UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Layer Grouping** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Grouping**.
...
- [x] `Layer Grouping` is implemented inside the allowed frontend paths.
