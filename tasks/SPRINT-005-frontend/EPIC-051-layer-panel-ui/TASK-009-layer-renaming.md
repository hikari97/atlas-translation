...
# TASK-009 — Layer Renaming

## Summary

Implement inline rename UI for layers.
...
After this task is complete, Atlas Studio frontend supports the **Layer Renaming** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Renaming**.
...
- [x] `Layer Renaming` is implemented inside the allowed frontend paths.
...
TASK-010-layer-context-menu.md
