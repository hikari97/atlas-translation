...
# TASK-007 — Layer Ordering

## Summary

Implement layer reorder UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Layer Ordering** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Ordering**.
...
- [x] `Layer Ordering` is implemented inside the allowed frontend paths.
