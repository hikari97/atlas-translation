...
# TASK-001 — Layers Panel

## Summary

Create layers panel inside editor shell.

This task belongs to **EPIC-051-layer-panel-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Layers Panel** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layers Panel**.
...
- [x] `Layers Panel` is implemented inside the allowed frontend paths.
