...
# TASK-006 — Layer Locking

## Summary

Implement lock/unlock UI boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Layer Locking** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Locking**.
...
- [x] `Layer Locking` is implemented inside the allowed frontend paths.
