...
# TASK-010 — Layer Context Menu

## Summary

Implement context menu action boundary.
...
After this task is complete, Atlas Studio frontend supports the **Layer Context Menu** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Context Menu**.
...
- [x] `Layer Context Menu` is implemented inside the allowed frontend paths.
