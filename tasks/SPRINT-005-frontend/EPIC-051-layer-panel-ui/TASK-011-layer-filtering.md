...
# TASK-011 — Layer Filtering

## Summary

Implement filtering by type, status, and search.
...
After this task is complete, Atlas Studio frontend supports the **Layer Filtering** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Filtering**.
...
- [x] `Layer Filtering` is implemented inside the allowed frontend paths.
...
TASK-012-layer-bulk-actions.md
