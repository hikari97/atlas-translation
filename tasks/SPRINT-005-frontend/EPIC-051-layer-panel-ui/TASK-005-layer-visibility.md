...
# TASK-005 — Layer Visibility

## Summary

Implement visibility toggles and visual states.
...
After this task is complete, Atlas Studio frontend supports the **Layer Visibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Visibility**.
...
- [x] `Layer Visibility` is implemented inside the allowed frontend paths.
