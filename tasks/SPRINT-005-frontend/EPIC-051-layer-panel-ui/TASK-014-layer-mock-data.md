...
# TASK-014 — Layer Mock Data

## Summary

Add deterministic layer fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Layer Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Mock Data**.
...
- [x] `Layer Mock Data` is implemented inside the allowed frontend paths.
