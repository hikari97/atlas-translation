...
Integrate layer selection with editor selection state.
...
After this task is complete, Atlas Studio frontend supports the **Layer Selection** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Selection**.
...
- [x] `Layer Selection` is implemented inside the allowed frontend paths.
