...
# TASK-002 — Layer Model UI

## Summary

Define frontend layer display model and layer type labels/icons.
...
After this task is complete, Atlas Studio frontend supports the **Layer Model UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Model UI**.
...
- [x] `Layer Model UI` is implemented inside the allowed frontend paths.
