...
# TASK-015 — Layer Panel Tests

## Summary

Add tests for layer render, selection, visibility, and ordering.
...
After this task is complete, Atlas Studio frontend supports the **Layer Panel Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Panel Tests**.
...
- [x] `Layer Panel Tests` is implemented inside the allowed frontend paths.
...
TASK-016-layer-accessibility.md
