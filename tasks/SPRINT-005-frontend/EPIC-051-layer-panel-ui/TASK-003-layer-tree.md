...
Implement layer tree/list rendering.
...
After this task is complete, Atlas Studio frontend supports the **Layer Tree** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Tree**.
...
- [x] `Layer Tree` is implemented inside the allowed frontend paths.
