...
Finalize public internal boundaries for apps/web foundation.
...
After this task is complete, Atlas Studio frontend supports the **Foundation Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Foundation Public Boundary**.
...
- [x] `Foundation Public Boundary` is implemented inside the allowed frontend paths.
