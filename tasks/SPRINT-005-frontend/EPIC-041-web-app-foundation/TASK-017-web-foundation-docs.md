...
# TASK-017 — Foundation Notes

## Summary

Add package-local notes for how the frontend foundation is organized.
...
After this task is complete, Atlas Studio frontend supports the **Foundation Notes** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Foundation Notes**.
...
- [x] `Foundation Notes` is implemented inside the allowed frontend paths.
...
TASK-018-web-foundation-public-boundary.md
