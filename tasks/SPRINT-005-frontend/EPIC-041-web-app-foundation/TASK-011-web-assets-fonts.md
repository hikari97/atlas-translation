...
# TASK-011 — Assets And Fonts

## Summary

Configure frontend static asset and font usage without hardcoded external dependencies.
...
After this task is complete, Atlas Studio frontend supports the **Assets And Fonts** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Assets And Fonts**.
...
- [x] `Assets And Fonts` is implemented inside the allowed frontend paths.
