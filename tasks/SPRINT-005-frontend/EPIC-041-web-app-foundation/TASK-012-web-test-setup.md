...
# TASK-012 — Frontend Test Setup

## Summary

Add package-local frontend test setup and testing utilities.
...
After this task is complete, Atlas Studio frontend supports the **Frontend Test Setup** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Frontend Test Setup**.
...
- [x] `Frontend Test Setup` is implemented inside the allowed frontend paths.
