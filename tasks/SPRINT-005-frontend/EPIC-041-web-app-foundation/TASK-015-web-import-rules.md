...
# TASK-015 — Frontend Import Rules

## Summary

Document and enforce local import boundaries within apps/web where possible.
...
After this task is complete, Atlas Studio frontend supports the **Frontend Import Rules** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Frontend Import Rules**.
...
- [x] `Frontend Import Rules` is implemented inside the allowed frontend paths.
...
TASK-016-web-basic-routing-tests.md
