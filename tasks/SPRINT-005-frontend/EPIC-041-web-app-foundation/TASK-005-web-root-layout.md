...
# TASK-005 — Root Layout

## Summary

Implement the root layout boundary for the web app.
...
After this task is complete, Atlas Studio frontend supports the **Root Layout** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Root Layout**.
...
- [x] `Root Layout` is implemented inside the allowed frontend paths.
...
TASK-006-web-provider-shell.md
