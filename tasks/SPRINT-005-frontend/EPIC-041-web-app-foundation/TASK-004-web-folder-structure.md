...
# TASK-004 — Frontend Folder Structure

## Summary

Create a clear apps/web source structure for app routes, components, features, hooks, lib, and tests.
...
After this task is complete, Atlas Studio frontend supports the **Frontend Folder Structure** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Frontend Folder Structure**.
...
- [x] `Frontend Folder Structure` is implemented inside the allowed frontend paths.
