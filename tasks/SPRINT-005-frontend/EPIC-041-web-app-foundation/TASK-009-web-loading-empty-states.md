...
# TASK-009 — Loading Empty States

## Summary

Implement shared loading, empty, and unavailable state primitives inside apps/web.
...
After this task is complete, Atlas Studio frontend supports the **Loading Empty States** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Loading Empty States**.
...
- [x] `Loading Empty States` is implemented inside the allowed frontend paths.
