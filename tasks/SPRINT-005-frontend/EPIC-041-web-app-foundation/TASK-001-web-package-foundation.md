...
# TASK-001 — Web Package Foundation

## Summary

Create or normalize the apps/web frontend package foundation.

This task belongs to **EPIC-041-web-app-foundation** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Web Package Foundation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Web Package Foundation**.
...
- [x] `Web Package Foundation` is implemented inside the allowed frontend paths.
