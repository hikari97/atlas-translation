...
# TASK-016 — Basic Routing Tests

## Summary

Add tests for route availability and root rendering boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Basic Routing Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Basic Routing Tests**.
...
- [x] `Basic Routing Tests` is implemented inside the allowed frontend paths.
...
TASK-017-web-foundation-docs.md
