...
# TASK-014 — Frontend Build Scripts

## Summary

Normalize package scripts for build, test, typecheck, and lint when available.
...
After this task is complete, Atlas Studio frontend supports the **Frontend Build Scripts** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Frontend Build Scripts**.
...
- [x] `Frontend Build Scripts` is implemented inside the allowed frontend paths.
