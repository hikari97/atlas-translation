...
# TASK-007 — Route Foundation

## Summary

Create base route structure for dashboard, projects, editor, settings, and auth placeholders.
...
After this task is complete, Atlas Studio frontend supports the **Route Foundation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Route Foundation**.
...
- [x] `Route Foundation` is implemented inside the allowed frontend paths.
...
TASK-008-web-error-boundary.md
