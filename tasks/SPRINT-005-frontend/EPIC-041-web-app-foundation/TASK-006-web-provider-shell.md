...
# TASK-006 — Provider Shell

## Summary

Implement frontend provider composition for theme, state, and application context.
...
After this task is complete, Atlas Studio frontend supports the **Provider Shell** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Provider Shell**.
...
- [x] `Provider Shell` is implemented inside the allowed frontend paths.
...
TASK-007-web-route-foundation.md
