...
# TASK-013 — Frontend Smoke Surface

## Summary

Create a minimal smoke surface proving the app renders.
...
After this task is complete, Atlas Studio frontend supports the **Frontend Smoke Surface** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Frontend Smoke Surface**.
...
- [x] `Frontend Smoke Surface` is implemented inside the allowed frontend paths.
