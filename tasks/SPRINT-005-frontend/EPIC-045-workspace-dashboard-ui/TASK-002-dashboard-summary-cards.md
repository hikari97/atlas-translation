...
# TASK-002 — Summary Cards

## Summary

Implement workspace summary cards for projects, pages, jobs, and exports.
...
After this task is complete, Atlas Studio frontend supports the **Summary Cards** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Summary Cards**.
...
- [x] `Summary Cards` is implemented inside the allowed frontend paths.
...
TASK-003-dashboard-recent-projects.md
