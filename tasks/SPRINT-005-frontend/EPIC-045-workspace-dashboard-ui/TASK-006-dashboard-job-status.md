...
# TASK-006 — Job Status Widget

## Summary

Implement job status widget for AI/OCR/translation/export work.
...
After this task is complete, Atlas Studio frontend supports the **Job Status Widget** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Job Status Widget**.
...
- [x] `Job Status Widget` is implemented inside the allowed frontend paths.
...
TASK-007-dashboard-empty-state.md
