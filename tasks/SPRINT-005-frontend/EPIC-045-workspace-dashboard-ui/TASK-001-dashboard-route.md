...
# TASK-001 — Dashboard Route

## Summary

Create the workspace dashboard route and layout integration.

This task belongs to **EPIC-045-workspace-dashboard-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Dashboard Route** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Dashboard Route**.
...
- [x] `Dashboard Route` is implemented inside the allowed frontend paths.
...
TASK-002-dashboard-summary-cards.md
