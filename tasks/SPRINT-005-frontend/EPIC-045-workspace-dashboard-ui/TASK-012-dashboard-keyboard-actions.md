...
# TASK-012 — Keyboard Actions

## Summary

Add keyboard-accessible dashboard actions.
...
After this task is complete, Atlas Studio frontend supports the **Keyboard Actions** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Keyboard Actions**.
...
- [x] `Keyboard Actions` is implemented inside the allowed frontend paths.
...
TASK-013-dashboard-data-hook.md
