...
# TASK-003 — Recent Projects

## Summary

Implement recent projects list/card UI.
...
After this task is complete, Atlas Studio frontend supports the **Recent Projects** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Recent Projects**.
...
- [x] `Recent Projects` is implemented inside the allowed frontend paths.
...
TASK-004-dashboard-quick-actions.md
