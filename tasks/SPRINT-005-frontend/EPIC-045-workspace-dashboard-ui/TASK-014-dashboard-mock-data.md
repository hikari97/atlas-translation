...
# TASK-014 — Dashboard Mock Data

## Summary

Add deterministic mock dashboard data for tests and development.
...
After this task is complete, Atlas Studio frontend supports the **Dashboard Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Dashboard Mock Data**.
...
- [x] `Dashboard Mock Data` is implemented inside the allowed frontend paths.
