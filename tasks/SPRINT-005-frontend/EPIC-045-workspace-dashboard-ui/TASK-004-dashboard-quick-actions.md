...
Implement quick action cards for import, new project, resume editing, and export review.
...
After this task is complete, Atlas Studio frontend supports the **Quick Actions** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Quick Actions**.
...
- [x] `Quick Actions` is implemented inside the allowed frontend paths.
...
TASK-005-dashboard-activity-feed.md
