...
# TASK-008 — Project Settings

## Summary

Implement project settings UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Project Settings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Project Settings**.
...
- [x] `Project Settings` is implemented inside the allowed frontend paths.
...
TASK-009-project-archive-delete.md
