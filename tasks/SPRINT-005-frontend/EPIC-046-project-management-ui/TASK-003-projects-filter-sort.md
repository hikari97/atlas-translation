...
# TASK-003 — Project Filters Sorting

## Summary

Implement project filtering, search, and sorting controls.
...
After this task is complete, Atlas Studio frontend supports the **Project Filters Sorting** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Project Filters Sorting**.
...
- [x] `Project Filters Sorting` is implemented inside the allowed frontend paths.
...
TASK-004-project-create-flow.md
