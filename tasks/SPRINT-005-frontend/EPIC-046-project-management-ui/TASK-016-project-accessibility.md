...
# TASK-016 — Project Accessibility

## Summary

Ensure project forms, dialogs, and lists are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Project Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Project Accessibility**.
...
- [x] `Project Accessibility` is implemented inside the allowed frontend paths.
...
TASK-017-project-responsive.md
