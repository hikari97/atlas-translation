...
# TASK-014 — Project Mock Data

## Summary

Add deterministic mock project data for tests and development.
...
After this task is complete, Atlas Studio frontend supports the **Project Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Project Mock Data**.
...
- [x] `Project Mock Data` is implemented inside the allowed frontend paths.
