...
# TASK-009 — Archive Delete UI

## Summary

Implement archive/delete confirmation UI without backend destructive behavior.
...
After this task is complete, Atlas Studio frontend supports the **Archive Delete UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Archive Delete UI**.
...
- [x] `Archive Delete UI` is implemented inside the allowed frontend paths.
