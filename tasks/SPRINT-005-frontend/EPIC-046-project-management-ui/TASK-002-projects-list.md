...
# TASK-002 — Projects List

## Summary

Implement project list UI with cards/table variants.
...
After this task is complete, Atlas Studio frontend supports the **Projects List** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Projects List**.
...
- [x] `Projects List` is implemented inside the allowed frontend paths.
...
TASK-003-projects-filter-sort.md
