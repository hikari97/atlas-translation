...
# TASK-001 — Projects Route

## Summary

Create projects list route and shell integration.

This task belongs to **EPIC-046-project-management-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Projects Route** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Projects Route**.
...
- [x] `Projects Route` is implemented inside the allowed frontend paths.
