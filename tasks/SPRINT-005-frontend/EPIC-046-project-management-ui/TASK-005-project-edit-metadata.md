...
# TASK-005 — Edit Project Metadata

## Summary

Implement edit metadata UI for title, language, format, and notes.
...
After this task is complete, Atlas Studio frontend supports the **Edit Project Metadata** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Edit Project Metadata**.
...
- [x] `Edit Project Metadata` is implemented inside the allowed frontend paths.
...
TASK-006-project-detail-route.md
