...
# TASK-011 — Language Settings

## Summary

Implement source/target language settings UI.
...
After this task is complete, Atlas Studio frontend supports the **Language Settings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Language Settings**.
...
- [x] `Language Settings` is implemented inside the allowed frontend paths.
...
TASK-012-project-collaboration-placeholder.md
