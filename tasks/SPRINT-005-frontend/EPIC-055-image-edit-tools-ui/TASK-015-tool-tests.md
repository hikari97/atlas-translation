...
# TASK-015 — Image Tool Tests

## Summary

Add tests for controls, state, and constraints.
...
After this task is complete, Atlas Studio frontend supports the **Image Tool Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Image Tool Tests**.
...
- [x] `Image Tool Tests` is implemented inside the allowed frontend paths.
...
TASK-016-tool-accessibility.md
