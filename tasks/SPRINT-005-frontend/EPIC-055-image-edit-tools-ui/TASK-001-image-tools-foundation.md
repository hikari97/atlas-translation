...
# TASK-001 — Image Tools Foundation

## Summary

Create image edit tools feature boundary.

This task belongs to **EPIC-055-image-edit-tools-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Image Tools Foundation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Image Tools Foundation**.
...
- [x] `Image Tools Foundation` is implemented inside the allowed frontend paths.
