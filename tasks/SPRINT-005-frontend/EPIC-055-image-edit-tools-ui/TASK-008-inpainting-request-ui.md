...
# TASK-008 — Inpainting Request UI

## Summary

Implement inpainting prompt/request UI boundary without running AI.
...
After this task is complete, Atlas Studio frontend supports the **Inpainting Request UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Inpainting Request UI**.
...
- [x] `Inpainting Request UI` is implemented inside the allowed frontend paths.
...
TASK-009-tool-cursor-preview.md
