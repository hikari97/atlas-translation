...
# TASK-005 — Restore Tool UI

## Summary

Implement restore-original-pixels tool UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Restore Tool UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Restore Tool UI**.
...
- [x] `Restore Tool UI` is implemented inside the allowed frontend paths.
