...
# TASK-009 — Tool Cursor Preview

## Summary

Implement brush/eraser cursor preview on canvas.
...
After this task is complete, Atlas Studio frontend supports the **Tool Cursor Preview** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Tool Cursor Preview**.
...
- [x] `Tool Cursor Preview` is implemented inside the allowed frontend paths.
...
TASK-010-tool-history-boundary.md
