...
# TASK-004 — Mask Tool UI

## Summary

Implement mask painting controls and overlay visibility.
...
After this task is complete, Atlas Studio frontend supports the **Mask Tool UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Mask Tool UI**.
...
- [x] `Mask Tool UI` is implemented inside the allowed frontend paths.
