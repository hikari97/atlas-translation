...
# TASK-014 — Tool Mock Data

## Summary

Add deterministic tool fixtures and canvas mocks.
...
After this task is complete, Atlas Studio frontend supports the **Tool Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Tool Mock Data**.
...
- [x] `Tool Mock Data` is implemented inside the allowed frontend paths.
