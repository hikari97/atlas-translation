...
# TASK-011 — Layer Integration

## Summary

Connect image tools to layer visibility/lock constraints.
...
After this task is complete, Atlas Studio frontend supports the **Layer Integration** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layer Integration**.
...
- [x] `Layer Integration` is implemented inside the allowed frontend paths.
...
TASK-012-tool-settings-persistence.md
