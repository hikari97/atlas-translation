...
# TASK-006 — Crop Tool UI

## Summary

Implement crop rectangle UI and confirmation boundary.
...
After this task is complete, Atlas Studio frontend supports the **Crop Tool UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Crop Tool UI**.
...
- [x] `Crop Tool UI` is implemented inside the allowed frontend paths.
...
TASK-007-image-transform-controls.md
