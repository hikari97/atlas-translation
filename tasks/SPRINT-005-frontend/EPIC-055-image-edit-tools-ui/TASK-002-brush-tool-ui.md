...
# TASK-002 — Brush Tool UI

## Summary

Implement brush tool controls for size, hardness, opacity, and mode.
...
After this task is complete, Atlas Studio frontend supports the **Brush Tool UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Brush Tool UI**.
...
- [x] `Brush Tool UI` is implemented inside the allowed frontend paths.
