...
# TASK-007 — Export Validation

## Summary

Implement frontend validation warnings for missing translations, overflow, low quality, and hidden layers.
...
After this task is complete, Atlas Studio frontend supports the **Export Validation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Validation**.
...
- [x] `Export Validation` is implemented inside the allowed frontend paths.
