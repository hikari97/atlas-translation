...
# TASK-013 — Export Data Hooks

## Summary

Integrate export UI with frontend data access and job boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Export Data Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Data Hooks**.
...
- [x] `Export Data Hooks` is implemented inside the allowed frontend paths.
