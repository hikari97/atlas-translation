...
# TASK-006 — Single Page Preview

## Summary

Implement single page preview surface.
...
After this task is complete, Atlas Studio frontend supports the **Single Page Preview** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Single Page Preview**.
...
- [x] `Single Page Preview` is implemented inside the allowed frontend paths.
