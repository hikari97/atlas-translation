...
# TASK-016 — Export Accessibility

## Summary

Ensure format controls and preview actions are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Export Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Accessibility**.
...
- [x] `Export Accessibility` is implemented inside the allowed frontend paths.
