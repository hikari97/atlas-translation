...
# TASK-004 — Quality Settings

## Summary

Implement quality, scale, compression, and output option controls.
...
After this task is complete, Atlas Studio frontend supports the **Quality Settings** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Quality Settings**.
...
- [x] `Quality Settings` is implemented inside the allowed frontend paths.
...
TASK-005-export-preview-grid.md
