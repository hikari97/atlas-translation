...
# TASK-018 — Export Public Boundary

## Summary

Finalize export preview feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Export Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Public Boundary**.
...
- [x] `Export Public Boundary` is implemented inside the allowed frontend paths.
