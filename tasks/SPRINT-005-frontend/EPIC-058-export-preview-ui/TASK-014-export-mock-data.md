...
# TASK-014 — Export Mock Data

## Summary

Add deterministic export fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Export Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Mock Data**.
...
- [x] `Export Mock Data` is implemented inside the allowed frontend paths.
