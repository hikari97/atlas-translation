...
# TASK-015 — Export UI Tests

## Summary

Add tests for settings, validation, preview, and job states.
...
After this task is complete, Atlas Studio frontend supports the **Export UI Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export UI Tests**.
...
- [x] `Export UI Tests` is implemented inside the allowed frontend paths.
...
TASK-016-export-accessibility.md
