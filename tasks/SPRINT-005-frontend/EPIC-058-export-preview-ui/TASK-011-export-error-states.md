...
# TASK-011 — Export Error States

## Summary

Implement export failure, retry, and partial result UI.
...
After this task is complete, Atlas Studio frontend supports the **Export Error States** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Error States**.
...
- [x] `Export Error States` is implemented inside the allowed frontend paths.
