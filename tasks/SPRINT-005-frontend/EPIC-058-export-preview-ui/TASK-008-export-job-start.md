...
# TASK-008 — Start Export UI

## Summary

Implement export job start action boundary.
...
After this task is complete, Atlas Studio frontend supports the **Start Export UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Start Export UI**.
...
- [x] `Start Export UI` is implemented inside the allowed frontend paths.
