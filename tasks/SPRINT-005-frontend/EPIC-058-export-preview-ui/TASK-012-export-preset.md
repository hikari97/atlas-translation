...
# TASK-012 — Export Presets

## Summary

Implement export preset selection and save/apply UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Export Presets** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Presets**.
...
- [x] `Export Presets` is implemented inside the allowed frontend paths.
