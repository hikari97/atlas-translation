...
# TASK-002 — Format Selection

## Summary

Implement export format selection for PNG, JPG, WEBP, PDF, CBZ, ZIP, and project archive UI.
...
After this task is complete, Atlas Studio frontend supports the **Format Selection** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Format Selection**.
...
- [x] `Format Selection` is implemented inside the allowed frontend paths.
