...
# TASK-005 — Preview Grid

## Summary

Implement export preview grid for pages.
...
After this task is complete, Atlas Studio frontend supports the **Preview Grid** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Preview Grid**.
...
- [x] `Preview Grid` is implemented inside the allowed frontend paths.
...
TASK-006-export-single-preview.md
