...
# TASK-001 — Export Preview Panel

## Summary

Create export preview panel/route boundary.

This task belongs to **EPIC-058-export-preview-ui** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Export Preview Panel** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Export Preview Panel**.
...
- [x] `Export Preview Panel` is implemented inside the allowed frontend paths.
...
TASK-002-export-format-selection.md
