...
# TASK-004 — Breadcrumbs

## Summary

Implement breadcrumb model and breadcrumb rendering.
...
After this task is complete, Atlas Studio frontend supports the **Breadcrumbs** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Breadcrumbs**.
...
- [x] `Breadcrumbs` is implemented inside the allowed frontend paths.
...
TASK-005-shell-navigation-config.md
