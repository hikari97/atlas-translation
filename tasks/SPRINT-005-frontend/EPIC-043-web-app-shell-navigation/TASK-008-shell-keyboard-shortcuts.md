...
# TASK-008 — Keyboard Shortcut Registry

## Summary

Implement frontend shortcut registry for shell-level actions.
...
After this task is complete, Atlas Studio frontend supports the **Keyboard Shortcut Registry** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Keyboard Shortcut Registry**.
...
- [x] `Keyboard Shortcut Registry` is implemented inside the allowed frontend paths.
