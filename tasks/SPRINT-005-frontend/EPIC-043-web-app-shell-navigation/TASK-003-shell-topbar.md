...
Implement top bar with page title, actions, and user/workspace area placeholder.
...
After this task is complete, Atlas Studio frontend supports the **Top Bar** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Top Bar**.
...
- [x] `Top Bar` is implemented inside the allowed frontend paths.
