...
# TASK-009 — Page Header

## Summary

Implement reusable page header component for frontend pages.
...
After this task is complete, Atlas Studio frontend supports the **Page Header** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Header**.
...
- [x] `Page Header` is implemented inside the allowed frontend paths.
...
TASK-010-shell-action-slots.md
