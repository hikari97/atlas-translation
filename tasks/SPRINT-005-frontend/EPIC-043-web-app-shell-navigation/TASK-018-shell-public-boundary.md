...
# TASK-018 — Shell Public Boundary

## Summary

Finalize shell component exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Shell Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shell Public Boundary**.
...
- [x] `Shell Public Boundary` is implemented inside the allowed frontend paths.
