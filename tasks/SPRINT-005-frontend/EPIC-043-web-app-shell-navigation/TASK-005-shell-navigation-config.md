...
# TASK-005 — Navigation Config

## Summary

Define typed navigation configuration and route metadata.
...
After this task is complete, Atlas Studio frontend supports the **Navigation Config** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Navigation Config**.
...
- [x] `Navigation Config` is implemented inside the allowed frontend paths.
...
TASK-006-shell-responsive-navigation.md
