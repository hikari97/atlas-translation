...
# TASK-016 — Navigation Tests

## Summary

Add tests for navigation config, rendering, and active route behavior.
...
After this task is complete, Atlas Studio frontend supports the **Navigation Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Navigation Tests**.
...
- [ ] `Navigation Tests` is implemented inside the allowed frontend paths.
...
TASK-017-shell-accessibility.md
