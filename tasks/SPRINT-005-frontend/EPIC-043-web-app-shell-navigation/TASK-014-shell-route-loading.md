...
# TASK-014 — Shell Loading States

## Summary

Implement loading states for app shell navigation.
...
After this task is complete, Atlas Studio frontend supports the **Shell Loading States** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shell Loading States**.
...
- [ ] `Shell Loading States` is implemented inside the allowed frontend paths.
