...
# TASK-001 — Shell Route Groups

## Summary

Create app shell route groups and layout boundaries.

This task belongs to **EPIC-043-web-app-shell-navigation** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Shell Route Groups** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shell Route Groups**.
...
- [x] `Shell Route Groups` is implemented inside the allowed frontend paths.
