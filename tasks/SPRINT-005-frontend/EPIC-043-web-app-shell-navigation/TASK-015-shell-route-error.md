...
# TASK-015 — Shell Error States

## Summary

Implement shell-level error UI surfaces.
...
After this task is complete, Atlas Studio frontend supports the **Shell Error States** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shell Error States**.
...
- [ ] `Shell Error States` is implemented inside the allowed frontend paths.
...
TASK-016-shell-navigation-tests.md
