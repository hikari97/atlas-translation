...
# TASK-012 — User Menu Placeholder

## Summary

Implement user menu UI boundary without auth provider coupling.
...
After this task is complete, Atlas Studio frontend supports the **User Menu Placeholder** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **User Menu Placeholder**.
...
- [x] `User Menu Placeholder` is implemented inside the allowed frontend paths.
...
TASK-013-shell-notification-entry.md
