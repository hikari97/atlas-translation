...
# TASK-002 — Sidebar Navigation

## Summary

Implement primary sidebar navigation for workspace, projects, editor, jobs, and settings.
...
After this task is complete, Atlas Studio frontend supports the **Sidebar Navigation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Sidebar Navigation**.
...
- [x] `Sidebar Navigation` is implemented inside the allowed frontend paths.
