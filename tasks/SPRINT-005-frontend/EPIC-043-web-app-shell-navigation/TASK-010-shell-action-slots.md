...
# TASK-010 — Action Slots

## Summary

Implement typed action slot model for shell pages.
...
After this task is complete, Atlas Studio frontend supports the **Action Slots** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Action Slots**.
...
- [x] `Action Slots` is implemented inside the allowed frontend paths.
...
TASK-011-shell-workspace-switcher.md
