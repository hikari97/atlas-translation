...
# TASK-017 — Shell Accessibility

## Summary

Ensure navigation landmarks, focus order, and keyboard behavior are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Shell Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Shell Accessibility**.
...
- [x] `Shell Accessibility` is implemented inside the allowed frontend paths.
...
TASK-018-shell-public-boundary.md
