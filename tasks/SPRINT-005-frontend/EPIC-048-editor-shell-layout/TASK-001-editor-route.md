...
# TASK-001 — Editor Route

## Summary

Create editor route structure and project/page routing boundary.

This task belongs to **EPIC-048-editor-shell-layout** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **Editor Route** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Route**.
...
- [x] `Editor Route` is implemented inside the allowed frontend paths.
...
TASK-002-editor-shell-layout.md
