...
# TASK-009 — Viewport State

## Summary

Implement viewport state boundaries for zoom, pan, fit, and scroll.
...
After this task is complete, Atlas Studio frontend supports the **Viewport State** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Viewport State**.
...
- [x] `Viewport State` is implemented inside the allowed frontend paths.
...
TASK-010-editor-selection-state.md
