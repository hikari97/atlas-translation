...
# TASK-014 — Mock Editor Document

## Summary

Add deterministic mock document/page data for disconnected editor UI development.
...
After this task is complete, Atlas Studio frontend supports the **Mock Editor Document** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Mock Editor Document**.
...
- [x] `Mock Editor Document` is implemented inside the allowed frontend paths.
