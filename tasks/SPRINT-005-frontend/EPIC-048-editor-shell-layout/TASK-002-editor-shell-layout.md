...
# TASK-002 — Editor Shell Layout

## Summary

Implement main editor layout with canvas, left panel, right inspector, top toolbar, and status bar.
...
After this task is complete, Atlas Studio frontend supports the **Editor Shell Layout** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Shell Layout**.
...
- [x] `Editor Shell Layout` is implemented inside the allowed frontend paths.
...
TASK-003-editor-panel-system.md
