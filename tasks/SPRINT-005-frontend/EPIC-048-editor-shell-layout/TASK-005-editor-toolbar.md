...
# TASK-005 — Editor Toolbar

## Summary

Implement editor toolbar action groups and tool slots.
...
After this task is complete, Atlas Studio frontend supports the **Editor Toolbar** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Toolbar**.
...
- [x] `Editor Toolbar` is implemented inside the allowed frontend paths.
