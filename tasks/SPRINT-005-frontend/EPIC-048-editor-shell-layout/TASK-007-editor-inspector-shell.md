...
# TASK-007 — Inspector Shell

## Summary

Implement right inspector container and tab boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Inspector Shell** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Inspector Shell**.
...
- [x] `Inspector Shell` is implemented inside the allowed frontend paths.
...
TASK-008-editor-left-panel-shell.md
