...
Implement editor status bar for zoom, selection, page, job, and save state.
...
After this task is complete, Atlas Studio frontend supports the **Status Bar** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Status Bar**.
...
- [x] `Status Bar` is implemented inside the allowed frontend paths.
...
TASK-007-editor-inspector-shell.md
