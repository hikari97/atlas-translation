...
# TASK-004 — Resizable Panels

## Summary

Implement resizable panel layout behavior.
...
After this task is complete, Atlas Studio frontend supports the **Resizable Panels** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Resizable Panels**.
...
- [x] `Resizable Panels` is implemented inside the allowed frontend paths.
