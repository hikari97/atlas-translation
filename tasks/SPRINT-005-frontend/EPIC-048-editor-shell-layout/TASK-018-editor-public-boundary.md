...
# TASK-018 — Editor Public Boundary

## Summary

Finalize editor shell feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Editor Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Public Boundary**.
...
- [x] `Editor Public Boundary` is implemented inside the allowed frontend paths.
