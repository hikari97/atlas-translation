...
# TASK-015 — Editor Shell Tests

## Summary

Add layout, toolbar, panel, and route tests.
...
After this task is complete, Atlas Studio frontend supports the **Editor Shell Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Shell Tests**.
...
- [x] `Editor Shell Tests` is implemented inside the allowed frontend paths.
...
TASK-016-editor-accessibility.md
