...
# TASK-008 — Left Panel Shell

## Summary

Implement left panel container for pages, layers, assets, and jobs.
...
After this task is complete, Atlas Studio frontend supports the **Left Panel Shell** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Left Panel Shell**.
...
- [x] `Left Panel Shell` is implemented inside the allowed frontend paths.
...
TASK-009-editor-viewport-state.md
