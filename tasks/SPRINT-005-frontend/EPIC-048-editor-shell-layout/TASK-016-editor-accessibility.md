...
# TASK-016 — Editor Accessibility

## Summary

Ensure editor shell landmarks, labels, and focus traps are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Editor Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Editor Accessibility**.
...
- [x] `Editor Accessibility` is implemented inside the allowed frontend paths.
