---
id: TASK-018
title: Selection Public Boundary
status: Completed
priority: High
story_points: 5
...
# TASK-018 — Selection Public Boundary

## Summary

Finalize selection feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Selection Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Selection Public Boundary**.
...
- [x] `Selection Public Boundary` is implemented inside the allowed frontend paths.
