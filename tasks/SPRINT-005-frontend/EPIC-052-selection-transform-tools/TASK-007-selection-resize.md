...
# TASK-007 — Resize Transform

## Summary

Implement resize transform calculations.
...
After this task is complete, Atlas Studio frontend supports the **Resize Transform** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Resize Transform**.
...
- [x] `Resize Transform` is implemented inside the allowed frontend paths.
