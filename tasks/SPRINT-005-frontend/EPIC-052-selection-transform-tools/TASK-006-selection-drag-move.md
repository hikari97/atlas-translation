...
Implement drag move behavior and coordinate updates.
...
After this task is complete, Atlas Studio frontend supports the **Drag Move** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Drag Move**.
...
- [x] `Drag Move` is implemented inside the allowed frontend paths.
