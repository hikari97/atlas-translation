...
# TASK-017 — Selection Performance

## Summary

Optimize transform calculations for multiple objects.
...
After this task is complete, Atlas Studio frontend supports the **Selection Performance** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Selection Performance**.
...
- [x] `Selection Performance` is implemented inside the allowed frontend paths.
...
TASK-018-selection-public-boundary.md
