...
Implement snap-to-object, snap-to-page, and snap-to-guide calculations.
...
After this task is complete, Atlas Studio frontend supports the **Snapping** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Snapping**.
...
- [x] `Snapping` is implemented inside the allowed frontend paths.
