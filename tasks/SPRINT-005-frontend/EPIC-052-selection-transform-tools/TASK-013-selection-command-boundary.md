...
# TASK-013 — Command Boundary

## Summary

Expose selection transforms through editor command boundary.
...
After this task is complete, Atlas Studio frontend supports the **Command Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Command Boundary**.
...
- [x] `Command Boundary` is implemented inside the allowed frontend paths.
...
TASK-014-selection-state-tests.md
