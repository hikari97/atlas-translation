...
# TASK-009 — Keyboard Nudge

## Summary

Implement keyboard movement and larger step movement.
...
After this task is complete, Atlas Studio frontend supports the **Keyboard Nudge** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Keyboard Nudge**.
...
- [x] `Keyboard Nudge` is implemented inside the allowed frontend paths.
...
TASK-010-selection-snapping.md
