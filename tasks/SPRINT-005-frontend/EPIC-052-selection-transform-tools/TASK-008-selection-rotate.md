...
# TASK-008 — Rotate Transform

## Summary

Implement rotate transform calculations.
...
After this task is complete, Atlas Studio frontend supports the **Rotate Transform** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Rotate Transform**.
...
- [x] `Rotate Transform` is implemented inside the allowed frontend paths.
...
TASK-009-selection-keyboard-nudge.md
