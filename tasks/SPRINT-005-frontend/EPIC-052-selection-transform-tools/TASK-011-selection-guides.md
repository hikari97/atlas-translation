...
Implement guide rendering and alignment hints.
...
After this task is complete, Atlas Studio frontend supports the **Guides** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Guides**.
...
- [x] `Guides` is implemented inside the allowed frontend paths.
...
TASK-012-selection-constraints.md
