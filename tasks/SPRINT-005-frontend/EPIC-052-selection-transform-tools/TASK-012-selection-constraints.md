...
# TASK-012 — Transform Constraints

## Summary

Implement locked/aspect/min-size constraint behavior.
...
After this task is complete, Atlas Studio frontend supports the **Transform Constraints** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Transform Constraints**.
...
- [x] `Transform Constraints` is implemented inside the allowed frontend paths.
...
TASK-013-selection-command-boundary.md
