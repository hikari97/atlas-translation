...
# TASK-004 — Bounding Box

## Summary

Implement bounding box calculation and rendering boundary.
...
After this task is complete, Atlas Studio frontend supports the **Bounding Box** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bounding Box**.
...
- [x] `Bounding Box` is implemented inside the allowed frontend paths.
...
TASK-005-selection-transform-handles.md
