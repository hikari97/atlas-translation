...
# TASK-003 — Multi Select

## Summary

Implement additive and range-like multi-selection behavior.
...
After this task is complete, Atlas Studio frontend supports the **Multi Select** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Multi Select**.
...
- [x] `Multi Select` is implemented inside the allowed frontend paths.
...
TASK-004-selection-bounding-box.md
