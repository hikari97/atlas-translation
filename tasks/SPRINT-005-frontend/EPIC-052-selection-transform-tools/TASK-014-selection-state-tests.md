...
# TASK-014 — Selection State Tests

## Summary

Add tests for selection model and calculations.
...
After this task is complete, Atlas Studio frontend supports the **Selection State Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Selection State Tests**.
...
- [x] `Selection State Tests` is implemented inside the allowed frontend paths.
...
TASK-015-selection-ui-tests.md
