...
# TASK-004 — Status Workflow

## Summary

Implement draft, translated, reviewed, approved, and needs-work statuses.
...
After this task is complete, Atlas Studio frontend supports the **Status Workflow** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Status Workflow**.
...
- [x] `Status Workflow` is implemented inside the allowed frontend paths.
...
TASK-005-translation-glossary-panel.md
