---
id: TASK-018
title: Translation Public Boundary
status: Completed
priority: High
story_points: 5
...
# TASK-018 — Translation Public Boundary

## Summary

Finalize translation workbench feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Translation Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Translation Public Boundary**.
...
- [x] `Translation Public Boundary` is implemented inside the allowed frontend paths.
