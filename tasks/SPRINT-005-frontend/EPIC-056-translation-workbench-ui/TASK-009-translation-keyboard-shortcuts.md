...
# TASK-009 — Keyboard Shortcuts

## Summary

Implement translator-focused keyboard shortcuts.
...
After this task is complete, Atlas Studio frontend supports the **Keyboard Shortcuts** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Keyboard Shortcuts**.
...
- [x] `Keyboard Shortcuts` is implemented inside the allowed frontend paths.
...
TASK-010-translation-side-by-side.md
