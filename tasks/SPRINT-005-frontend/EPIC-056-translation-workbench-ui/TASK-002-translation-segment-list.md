...
# TASK-002 — Segment List

## Summary

Implement translation segment list for page/project text.
...
After this task is complete, Atlas Studio frontend supports the **Segment List** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Segment List**.
...
- [x] `Segment List` is implemented inside the allowed frontend paths.
...
TASK-003-translation-source-target-editor.md
