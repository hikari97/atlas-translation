...
# TASK-015 — Translation Mock Data

## Summary

Add deterministic translation fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Translation Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Translation Mock Data**.
...
- [x] `Translation Mock Data` is implemented inside the allowed frontend paths.
