...
Synchronize workbench selection with editor page/bubble selection.
...
After this task is complete, Atlas Studio frontend supports the **Page Sync** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Page Sync**.
...
- [x] `Page Sync` is implemented inside the allowed frontend paths.
...
TASK-012-translation-quality-warnings.md
