...
# TASK-003 — Source Target Editor

## Summary

Implement paired source and target text editor UI.
...
After this task is complete, Atlas Studio frontend supports the **Source Target Editor** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Source Target Editor**.
...
- [x] `Source Target Editor` is implemented inside the allowed frontend paths.
...
TASK-004-translation-status-workflow.md
