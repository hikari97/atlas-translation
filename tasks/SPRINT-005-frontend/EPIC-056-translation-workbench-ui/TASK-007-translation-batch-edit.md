...
Implement batch edit, apply, and status update UI boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Batch Edit** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Batch Edit**.
...
- [x] `Batch Edit` is implemented inside the allowed frontend paths.
...
TASK-008-translation-search-filter.md
