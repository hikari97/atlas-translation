...
# TASK-017 — Translation Accessibility

## Summary

Ensure editor fields and shortcuts are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Translation Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Translation Accessibility**.
...
- [x] `Translation Accessibility` is implemented inside the allowed frontend paths.
...
TASK-018-translation-public-boundary.md
