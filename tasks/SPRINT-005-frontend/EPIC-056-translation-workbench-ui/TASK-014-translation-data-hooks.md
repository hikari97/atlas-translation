...
# TASK-014 — Translation Data Hooks

## Summary

Integrate workbench with frontend state/data boundary.
...
After this task is complete, Atlas Studio frontend supports the **Translation Data Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Translation Data Hooks**.
...
- [x] `Translation Data Hooks` is implemented inside the allowed frontend paths.
...
TASK-015-translation-mock-data.md
