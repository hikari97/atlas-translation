...
# TASK-007 — Bubble Status Workflow

## Summary

Implement statuses for detected, OCR, translated, reviewed, approved.
...
After this task is complete, Atlas Studio frontend supports the **Bubble Status Workflow** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bubble Status Workflow**.
...
- [x] `Bubble Status Workflow` is implemented inside the allowed frontend paths.
...
TASK-008-bubble-link-canvas-selection.md
