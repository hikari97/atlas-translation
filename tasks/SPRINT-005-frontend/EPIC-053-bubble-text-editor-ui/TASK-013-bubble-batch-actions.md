...
# TASK-013 — Batch Actions

## Summary

Implement batch status and selection actions.
...
After this task is complete, Atlas Studio frontend supports the **Batch Actions** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Batch Actions**.
...
- [x] `Batch Actions` is implemented inside the allowed frontend paths.
