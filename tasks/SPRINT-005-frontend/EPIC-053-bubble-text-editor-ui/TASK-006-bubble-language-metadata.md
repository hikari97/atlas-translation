...
# TASK-006 — Language Metadata

## Summary

Implement source/target language metadata UI.
...
After this task is complete, Atlas Studio frontend supports the **Language Metadata** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Language Metadata**.
...
- [x] `Language Metadata` is implemented inside the allowed frontend paths.
...
TASK-007-bubble-status-workflow.md
