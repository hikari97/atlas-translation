...
# TASK-012 — Comments Notes

## Summary

Implement notes/comments UI boundary for translation review.
...
After this task is complete, Atlas Studio frontend supports the **Comments Notes** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Comments Notes**.
...
- [x] `Comments Notes` is implemented inside the allowed frontend paths.
...
TASK-013-bubble-batch-actions.md
