...
# TASK-010 — Delete Restore Bubble

## Summary

Implement delete/restore confirmation UI boundary.
...
After this task is complete, Atlas Studio frontend supports the **Delete Restore Bubble** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Delete Restore Bubble**.
...
- [x] `Delete Restore Bubble` is implemented inside the allowed frontend paths.
...
TASK-011-bubble-confidence-ui.md
