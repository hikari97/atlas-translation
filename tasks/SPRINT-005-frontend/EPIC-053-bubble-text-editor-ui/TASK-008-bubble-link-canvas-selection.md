...
# TASK-008 — Canvas Selection Link

## Summary

Link bubble list/inspector with canvas selection state.
...
After this task is complete, Atlas Studio frontend supports the **Canvas Selection Link** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Canvas Selection Link**.
...
- [x] `Canvas Selection Link` is implemented inside the allowed frontend paths.
...
TASK-009-bubble-create-edit.md
