...
# TASK-015 — Bubble Mock Data

## Summary

Add deterministic bubble/text fixtures.
...
After this task is complete, Atlas Studio frontend supports the **Bubble Mock Data** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bubble Mock Data**.
...
- [x] `Bubble Mock Data` is implemented inside the allowed frontend paths.
