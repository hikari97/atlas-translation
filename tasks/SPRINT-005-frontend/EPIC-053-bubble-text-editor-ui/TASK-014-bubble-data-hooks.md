...
# TASK-014 — Bubble Data Hooks

## Summary

Integrate bubble editor with frontend state/data access boundary.
...
After this task is complete, Atlas Studio frontend supports the **Bubble Data Hooks** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bubble Data Hooks**.
...
- [x] `Bubble Data Hooks` is implemented inside the allowed frontend paths.
