...
# TASK-011 — Confidence UI

## Summary

Display OCR/translation confidence and warning indicators.
...
After this task is complete, Atlas Studio frontend supports the **Confidence UI** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Confidence UI**.
...
- [x] `Confidence UI` is implemented inside the allowed frontend paths.
...
TASK-012-bubble-comments-notes.md
