...
# TASK-017 — Bubble Accessibility

## Summary

Ensure text fields, lists, and status actions are accessible.
...
After this task is complete, Atlas Studio frontend supports the **Bubble Accessibility** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bubble Accessibility**.
...
- [x] `Bubble Accessibility` is implemented inside the allowed frontend paths.
...
TASK-018-bubble-public-boundary.md
