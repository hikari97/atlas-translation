...
# TASK-004 — Original Text Field

## Summary

Implement original OCR text display/edit field boundary.
...
After this task is complete, Atlas Studio frontend supports the **Original Text Field** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Original Text Field**.
...
- [x] `Original Text Field` is implemented inside the allowed frontend paths.
...
TASK-005-bubble-translated-text.md
