...
# TASK-018 — Bubble Public Boundary

## Summary

Finalize bubble editor feature exports and internal boundaries.
...
After this task is complete, Atlas Studio frontend supports the **Bubble Public Boundary** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Bubble Public Boundary**.
...
- [x] `Bubble Public Boundary` is implemented inside the allowed frontend paths.
