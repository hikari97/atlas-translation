...
# TASK-005 — Translated Text Field

## Summary

Implement translated text editor field.
...
After this task is complete, Atlas Studio frontend supports the **Translated Text Field** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Translated Text Field**.
...
- [x] `Translated Text Field` is implemented inside the allowed frontend paths.
...
TASK-006-bubble-language-metadata.md
