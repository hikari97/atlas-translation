...
# TASK-004 — Layout Primitives

## Summary

Implement reusable layout primitives for stack, grid, panel, split, and page surfaces.
...
After this task is complete, Atlas Studio frontend supports the **Layout Primitives** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Layout Primitives**.
...
- [x] `Layout Primitives` is implemented inside the allowed frontend paths.
...
TASK-005-ui-button-controls.md
