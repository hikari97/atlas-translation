...
# TASK-005 — Button Controls

## Summary

Implement button, icon button, toggle, and segmented control primitives.
...
After this task is complete, Atlas Studio frontend supports the **Button Controls** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Button Controls**.
...
- [x] `Button Controls` is implemented inside the allowed frontend paths.
