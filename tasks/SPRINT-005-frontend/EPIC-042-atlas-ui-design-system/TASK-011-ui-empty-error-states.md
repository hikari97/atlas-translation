...
# TASK-011 — Empty Error States

## Summary

Implement reusable empty, error, and offline state components.
...
After this task is complete, Atlas Studio frontend supports the **Empty Error States** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Empty Error States**.
...
- [x] `Empty Error States` is implemented inside the allowed frontend paths.
