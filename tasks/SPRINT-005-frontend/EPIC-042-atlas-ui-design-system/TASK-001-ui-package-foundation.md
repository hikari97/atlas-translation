...
# TASK-001 — UI Package Foundation

## Summary

Create or normalize the packages/atlas-ui design system package.

This task belongs to **EPIC-042-atlas-ui-design-system** and must be implemented only inside the allowed frontend paths.

---

# Capability

After this task is complete, Atlas Studio frontend supports the **UI Package Foundation** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **UI Package Foundation**.
...
- [x] `UI Package Foundation` is implemented inside the allowed frontend paths.
