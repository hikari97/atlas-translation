...
# TASK-017 — UI Export Index

## Summary

Finalize package exports and internal/public component boundaries.
...
After this task is complete, Atlas Studio frontend supports the **UI Export Index** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **UI Export Index**.
...
- [x] `UI Export Index` is implemented inside the allowed frontend paths.
...
TASK-018-ui-design-system-docs.md
