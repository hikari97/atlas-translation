...
# TASK-015 — Component Tests

## Summary

Add unit and rendering tests for shared UI components.
...
After this task is complete, Atlas Studio frontend supports the **Component Tests** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Component Tests**.
...
- [x] `Component Tests` is implemented inside the allowed frontend paths.
...
TASK-016-ui-visual-fixtures.md
