...
# TASK-013 — Accessibility Helpers

## Summary

Implement focus, aria, keyboard, and visually-hidden helpers.
...
After this task is complete, Atlas Studio frontend supports the **Accessibility Helpers** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Accessibility Helpers**.
...
- [x] `Accessibility Helpers` is implemented inside the allowed frontend paths.
...
TASK-014-ui-responsive-helpers.md
