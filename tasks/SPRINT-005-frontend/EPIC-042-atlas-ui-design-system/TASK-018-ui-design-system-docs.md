...
# TASK-018 — Design System Notes

## Summary

Add package-local documentation notes for design system usage.
...
After this task is complete, Atlas Studio frontend supports the **Design System Notes** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Design System Notes**.
...
- [x] `Design System Notes` is implemented inside the allowed frontend paths.
