...
# TASK-002 — Theme Tokens

## Summary

Define color, spacing, typography, radius, shadow, and z-index tokens.
...
After this task is complete, Atlas Studio frontend supports the **Theme Tokens** capability.

---

# Goal

Implement the smallest production-quality frontend increment needed for **Theme Tokens**.
...
- [x] `Theme Tokens` is implemented inside the allowed frontend paths.
