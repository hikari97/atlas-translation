...
# TASK-006 — Trigger Calculator

## Summary

Implement next-run calculation boundaries and result contracts.
...
After this task is complete, Atlas supports the `Trigger Calculator` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Trigger Calculator**.
...
- [x] `Trigger Calculator` is implemented inside `packages/atlas-scheduler`.
...
TASK-007-scheduler-job-registry.md
