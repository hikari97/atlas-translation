---
id: TASK-017
title: Scheduler Test Utilities
status: Completed
priority: High
story_points: 5
...
# TASK-017 — Scheduler Test Utilities

## Summary

Create deterministic clocks, fake stores, and scheduler assertions.
...
After this task is complete, Atlas supports the `Scheduler Test Utilities` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Scheduler Test Utilities**.
...
- [x] `Scheduler Test Utilities` is implemented inside `packages/atlas-scheduler`.
...
TASK-018-scheduler-public-api.md
