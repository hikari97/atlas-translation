...
# TASK-002 — Scheduler Core Types

## Summary

Define schedule IDs, job IDs, states, options, and result contracts.
...
After this task is complete, Atlas supports the `Scheduler Core Types` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Scheduler Core Types**.
...
- [x] `Scheduler Core Types` is implemented inside `packages/atlas-scheduler`.
...
TASK-003-scheduler-definition.md
