...
# TASK-003 — Schedule Definition

## Summary

Define one-time, interval, cron-like, and disabled schedule contracts.
...
After this task is complete, Atlas supports the `Schedule Definition` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Schedule Definition**.
...
- [x] `Schedule Definition` is implemented inside `packages/atlas-scheduler`.
...
TASK-004-scheduler-expression-validation.md
