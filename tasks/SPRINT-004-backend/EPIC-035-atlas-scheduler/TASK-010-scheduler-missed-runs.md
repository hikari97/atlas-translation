...
# TASK-010 — Missed Runs

## Summary

Implement missed-run policies, catch-up behavior, and skip behavior descriptors.
...
After this task is complete, Atlas supports the `Missed Runs` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Missed Runs**.
...
- [x] `Missed Runs` is implemented inside `packages/atlas-scheduler`.
...
TASK-011-scheduler-timezone.md
