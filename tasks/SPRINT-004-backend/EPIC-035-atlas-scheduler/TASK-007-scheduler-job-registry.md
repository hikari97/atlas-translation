...
# TASK-007 — Job Registry

## Summary

Implement scheduled job registry descriptors and validation.
...
After this task is complete, Atlas supports the `Job Registry` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Job Registry**.
...
- [x] `Job Registry` is implemented inside `packages/atlas-scheduler`.
