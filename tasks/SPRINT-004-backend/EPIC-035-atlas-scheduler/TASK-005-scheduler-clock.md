...
# TASK-005 — Clock Abstraction

## Summary

Implement deterministic clock abstraction for schedule evaluation.
...
After this task is complete, Atlas supports the `Clock Abstraction` capability for `atlas-scheduler`.

---

# Goal

Implement the smallest production-quality increment needed for **Clock Abstraction**.
...
- [x] `Clock Abstraction` is implemented inside `packages/atlas-scheduler`.
...
TASK-006-scheduler-trigger-calculator.md
