...
# TASK-015 — Database Integration

## Summary

Integrate atlas-orm contracts with atlas-database public API only.
...
After this task is complete, Atlas supports the `Database Integration` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Integration**.
...
- [x] `Database Integration` is implemented inside `packages/atlas-orm`.
