...
# TASK-005 — Model Schema

## Summary

Implement serializable model schema contracts.
...
After this task is complete, Atlas supports the `Model Schema` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Model Schema**.
...
- [x] `Model Schema` is implemented inside `packages/atlas-orm`.
...
TASK-006-orm-relation-definition.md
