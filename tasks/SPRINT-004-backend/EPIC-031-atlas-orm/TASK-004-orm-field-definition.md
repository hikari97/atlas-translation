...
# TASK-004 — Field Definition

## Summary

Define scalar field metadata, nullability, defaults, and constraints.
...
After this task is complete, Atlas supports the `Field Definition` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Field Definition**.
...
- [x] `Field Definition` is implemented inside `packages/atlas-orm`.
