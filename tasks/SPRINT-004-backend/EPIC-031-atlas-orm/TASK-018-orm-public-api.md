...
After this task is complete, Atlas supports the `ORM Public API` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **ORM Public API**.
...
- [x] `ORM Public API` is implemented inside `packages/atlas-orm`.
