...
# TASK-007 — Query Descriptor

## Summary

Define provider-neutral ORM query descriptors.
...
After this task is complete, Atlas supports the `Query Descriptor` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Query Descriptor**.
...
- [x] `Query Descriptor` is implemented inside `packages/atlas-orm`.
...
TASK-008-orm-filter-operators.md
