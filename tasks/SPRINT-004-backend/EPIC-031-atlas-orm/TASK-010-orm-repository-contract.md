...
# TASK-010 — Repository Contract

## Summary

Define typed repository contracts over entity schemas.
...
After this task is complete, Atlas supports the `Repository Contract` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Repository Contract**.
...
- [x] `Repository Contract` is implemented inside `packages/atlas-orm`.
...
TASK-011-orm-repository-implementation.md
