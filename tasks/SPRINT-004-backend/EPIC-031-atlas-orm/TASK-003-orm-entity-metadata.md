...
# TASK-003 — Entity Metadata

## Summary

Define entity metadata without decorators or runtime reflection.
...
After this task is complete, Atlas supports the `Entity Metadata` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Entity Metadata**.
...
- [x] `Entity Metadata` is implemented inside `packages/atlas-orm`.
...
TASK-004-orm-field-definition.md
