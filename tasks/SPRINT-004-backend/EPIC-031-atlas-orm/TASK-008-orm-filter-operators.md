...
# TASK-008 — Filter Operators

## Summary

Implement comparison and logical filter operator helpers.
...
After this task is complete, Atlas supports the `Filter Operators` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Filter Operators**.
...
- [x] `Filter Operators` is implemented inside `packages/atlas-orm`.
...
TASK-009-orm-projection-sorting-pagination.md
