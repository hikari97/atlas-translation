...
# TASK-017 — ORM Test Utilities

## Summary

Create fixtures, fake repositories, and mapper test helpers.
...
After this task is complete, Atlas supports the `ORM Test Utilities` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **ORM Test Utilities**.
...
- [x] `ORM Test Utilities` is implemented inside `packages/atlas-orm`.
