...
# TASK-006 — Relation Definition

## Summary

Define relation metadata for one-to-one, one-to-many, many-to-one, and many-to-many.
...
After this task is complete, Atlas supports the `Relation Definition` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Relation Definition**.
...
- [x] `Relation Definition` is implemented inside `packages/atlas-orm`.
...
TASK-007-orm-query-descriptor.md
