...
# TASK-012 — Unit Of Work

## Summary

Define unit-of-work contracts for coordinated repository operations.
...
After this task is complete, Atlas supports the `Unit Of Work` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Unit Of Work**.
...
- [x] `Unit Of Work` is implemented inside `packages/atlas-orm`.
