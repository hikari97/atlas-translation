...
# TASK-011 — Repository Implementation

## Summary

Implement repository orchestration over atlas-database client boundaries.
...
After this task is complete, Atlas supports the `Repository Implementation` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Repository Implementation**.
...
- [x] `Repository Implementation` is implemented inside `packages/atlas-orm`.
