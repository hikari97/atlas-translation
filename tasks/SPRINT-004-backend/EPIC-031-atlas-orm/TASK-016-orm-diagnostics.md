...
# TASK-016 — ORM Diagnostics

## Summary

Define diagnostics events and safe debug payloads for ORM operations.
...
After this task is complete, Atlas supports the `ORM Diagnostics` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **ORM Diagnostics**.
...
- [x] `ORM Diagnostics` is implemented inside `packages/atlas-orm`.
...
TASK-017-orm-test-utilities.md
