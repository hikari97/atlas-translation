...
# TASK-013 — Entity Mapper

## Summary

Implement entity-to-record and record-to-entity mapper boundaries.
...
After this task is complete, Atlas supports the `Entity Mapper` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **Entity Mapper**.
...
- [x] `Entity Mapper` is implemented inside `packages/atlas-orm`.
