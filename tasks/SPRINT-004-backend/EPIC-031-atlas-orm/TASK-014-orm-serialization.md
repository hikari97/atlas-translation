...
# TASK-014 — ORM Serialization

## Summary

Implement safe plain-object serialization helpers.
...
After this task is complete, Atlas supports the `ORM Serialization` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **ORM Serialization**.
...
- [x] `ORM Serialization` is implemented inside `packages/atlas-orm`.
...
TASK-015-orm-database-integration.md
