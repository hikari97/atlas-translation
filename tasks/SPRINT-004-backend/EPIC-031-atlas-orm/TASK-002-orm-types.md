...
# TASK-002 — ORM Core Types

## Summary

Define entity identifiers, model identifiers, entity state, options, and result contracts.
...
After this task is complete, Atlas supports the `ORM Core Types` capability for `atlas-orm`.

---

# Goal

Implement the smallest production-quality increment needed for **ORM Core Types**.
...
- [x] `ORM Core Types` is implemented inside `packages/atlas-orm`.
...
TASK-003-orm-entity-metadata.md
