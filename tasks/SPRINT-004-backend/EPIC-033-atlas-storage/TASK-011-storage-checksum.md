...
Implement checksum calculation and verification boundaries.
...
After this task is complete, Atlas supports the `Checksum` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Checksum**.
...
- [x] `Checksum` is implemented inside `packages/atlas-storage`.
