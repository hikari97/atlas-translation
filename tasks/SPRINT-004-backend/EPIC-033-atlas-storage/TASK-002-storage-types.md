...
# TASK-002 — Storage Core Types

## Summary

Define storage identifiers, object references, operation options, and result contracts.
...
After this task is complete, Atlas supports the `Storage Core Types` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Storage Core Types**.
...
- [x] `Storage Core Types` is implemented inside `packages/atlas-storage`.
