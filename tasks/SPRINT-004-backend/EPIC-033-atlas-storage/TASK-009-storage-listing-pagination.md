...
# TASK-009 — Listing Pagination

## Summary

Implement listing descriptors, prefixes, cursors, and list results.
...
After this task is complete, Atlas supports the `Listing Pagination` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Listing Pagination**.
...
- [x] `Listing Pagination` is implemented inside `packages/atlas-storage`.
...
TASK-010-storage-bucket-namespace.md
