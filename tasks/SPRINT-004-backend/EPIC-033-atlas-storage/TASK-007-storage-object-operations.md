...
# TASK-007 — Object Operations

## Summary

Implement put, get, exists, delete, copy, and move operation helpers.
...
After this task is complete, Atlas supports the `Object Operations` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Object Operations**.
...
- [x] `Object Operations` is implemented inside `packages/atlas-storage`.
...
TASK-008-storage-payload-boundary.md
