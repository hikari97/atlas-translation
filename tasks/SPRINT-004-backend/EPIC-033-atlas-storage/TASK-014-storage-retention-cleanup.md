---
id: TASK-014
title: Retention Cleanup Contract
status: Completed
priority: High
story_points: 5
...
# TASK-014 — Retention Cleanup Contract

## Summary

Define retention and cleanup descriptors without destructive background behavior.
...
After this task is complete, Atlas supports the `Retention Cleanup Contract` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Retention Cleanup Contract**.
...
- [x] `Retention Cleanup Contract` is implemented inside `packages/atlas-storage`.
...
TASK-015-storage-config-integration.md
