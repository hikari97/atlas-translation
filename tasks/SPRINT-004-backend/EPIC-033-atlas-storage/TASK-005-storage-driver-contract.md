...
# TASK-005 — Storage Driver Contract

## Summary

Define storage driver operations without cloud provider coupling.
...
After this task is complete, Atlas supports the `Storage Driver Contract` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Storage Driver Contract**.
...
- [x] `Storage Driver Contract` is implemented inside `packages/atlas-storage`.
...
TASK-006-storage-local-driver.md
