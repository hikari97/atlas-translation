...
# TASK-017 — Storage Test Utilities

## Summary

Create temporary storage, fake drivers, and storage assertions.
...
After this task is complete, Atlas supports the `Storage Test Utilities` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Storage Test Utilities**.
...
- [x] `Storage Test Utilities` is implemented inside `packages/atlas-storage`.
...
TASK-018-storage-public-api.md
