...
After this task is complete, Atlas supports the `Storage Public API` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Storage Public API**.
...
- [x] `Storage Public API` is implemented inside `packages/atlas-storage`.
