...
# TASK-004 — Storage Metadata

## Summary

Define object metadata, content type, size, checksum, timestamps, and custom metadata.
...
After this task is complete, Atlas supports the `Storage Metadata` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Storage Metadata**.
...
- [x] `Storage Metadata` is implemented inside `packages/atlas-storage`.
...
TASK-005-storage-driver-contract.md
