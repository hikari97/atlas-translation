...
# TASK-015 — Config Integration

## Summary

Expose atlas-config integration boundary for storage configuration.
...
After this task is complete, Atlas supports the `Config Integration` capability for `atlas-storage`.

---

# Goal

Implement the smallest production-quality increment needed for **Config Integration**.
...
- [x] `Config Integration` is implemented inside `packages/atlas-storage`.
...
TASK-016-storage-runtime-integration.md
