...
# TASK-014 — State Model

## Summary

Define read/unread, archived, dismissed, and delivery state contracts.
...
After this task is complete, Atlas supports the `State Model` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **State Model**.
...
- [x] `State Model` is implemented inside `packages/atlas-notification`.
...
TASK-015-notification-dedup-rate-limit.md
