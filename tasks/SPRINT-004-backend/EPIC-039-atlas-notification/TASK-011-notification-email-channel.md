...
# TASK-011 — Email Channel

## Summary

Expose email channel bridge to atlas-mail public API.
...
After this task is complete, Atlas supports the `Email Channel` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Email Channel**.
...
- [x] `Email Channel` is implemented inside `packages/atlas-notification`.
...
TASK-012-notification-queue-integration.md
