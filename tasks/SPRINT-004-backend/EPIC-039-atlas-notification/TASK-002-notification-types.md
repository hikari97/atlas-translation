...
# TASK-002 — Notification Core Types

## Summary

Define notification IDs, recipient IDs, operation options, and result contracts.
...
After this task is complete, Atlas supports the `Notification Core Types` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Notification Core Types**.
...
- [x] `Notification Core Types` is implemented inside `packages/atlas-notification`.
...
TASK-003-notification-channel.md
