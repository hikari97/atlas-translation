...
# TASK-004 — Recipient Model

## Summary

Define recipient references and recipient metadata.
...
After this task is complete, Atlas supports the `Recipient Model` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Recipient Model**.
...
- [x] `Recipient Model` is implemented inside `packages/atlas-notification`.
...
TASK-005-notification-preferences.md
