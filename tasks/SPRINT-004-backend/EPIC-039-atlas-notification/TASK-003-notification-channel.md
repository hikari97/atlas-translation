...
# TASK-003 — Channel Model

## Summary

Define provider-neutral notification channel contracts.
...
After this task is complete, Atlas supports the `Channel Model` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Channel Model**.
...
- [x] `Channel Model` is implemented inside `packages/atlas-notification`.
...
TASK-004-notification-recipient.md
