...
# TASK-010 — In-App Channel

## Summary

Implement provider-neutral in-app channel and in-memory development channel.
...
After this task is complete, Atlas supports the `In-App Channel` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **In-App Channel**.
...
- [x] `In-App Channel` is implemented inside `packages/atlas-notification`.
...
TASK-011-notification-email-channel.md
