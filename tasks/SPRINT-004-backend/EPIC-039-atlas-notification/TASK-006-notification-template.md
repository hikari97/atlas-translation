...
# TASK-006 — Notification Template

## Summary

Define title, body, action, locale, and channel-specific template content.
...
After this task is complete, Atlas supports the `Notification Template` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Notification Template**.
...
- [x] `Notification Template` is implemented inside `packages/atlas-notification`.
...
TASK-007-notification-event.md
