...
# TASK-012 — Queue Integration

## Summary

Expose asynchronous delivery boundaries to atlas-queue.
...
After this task is complete, Atlas supports the `Queue Integration` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Queue Integration**.
...
- [x] `Queue Integration` is implemented inside `packages/atlas-notification`.
...
TASK-013-notification-scheduler-integration.md
