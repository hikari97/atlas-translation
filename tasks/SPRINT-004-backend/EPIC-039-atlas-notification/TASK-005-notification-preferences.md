...
# TASK-005 — Recipient Preferences

## Summary

Implement preference contracts and resolution helpers.
...
After this task is complete, Atlas supports the `Recipient Preferences` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Recipient Preferences**.
...
- [x] `Recipient Preferences` is implemented inside `packages/atlas-notification`.
...
TASK-006-notification-template.md
