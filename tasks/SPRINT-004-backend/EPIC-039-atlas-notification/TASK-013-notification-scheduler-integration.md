...
# TASK-013 — Scheduler Integration

## Summary

Expose delayed notification boundaries to atlas-scheduler.
...
After this task is complete, Atlas supports the `Scheduler Integration` capability for `atlas-notification`.

---

# Goal

Implement the smallest production-quality increment needed for **Scheduler Integration**.
...
- [x] `Scheduler Integration` is implemented inside `packages/atlas-notification`.
...
TASK-014-notification-state-model.md
