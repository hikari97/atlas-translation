...
# TASK-002 — Search Core Types

## Summary

Define index IDs, document IDs, operation options, and result contracts.
...
After this task is complete, Atlas supports the `Search Core Types` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Search Core Types**.
...
- [x] `Search Core Types` is implemented inside `packages/atlas-search`.
...
TASK-003-search-index-schema.md
