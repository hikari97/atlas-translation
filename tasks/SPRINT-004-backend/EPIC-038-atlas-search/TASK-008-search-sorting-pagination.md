...
# TASK-008 — Sorting Pagination

## Summary

Implement sorting, pagination, cursor, and result metadata.
...
After this task is complete, Atlas supports the `Sorting Pagination` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Sorting Pagination**.
...
- [x] `Sorting Pagination` is implemented inside `packages/atlas-search`.
...
TASK-009-search-memory-adapter.md
