...
# TASK-007 — Search Filter

## Summary

Implement filter descriptors and validation helpers.
...
After this task is complete, Atlas supports the `Search Filter` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Search Filter**.
...
- [x] `Search Filter` is implemented inside `packages/atlas-search`.
...
TASK-008-search-sorting-pagination.md
