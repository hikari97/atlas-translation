...
# TASK-005 — Analyzer Contract

## Summary

Define analyzer/tokenizer contracts without provider coupling.
...
After this task is complete, Atlas supports the `Analyzer Contract` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Analyzer Contract**.
...
- [x] `Analyzer Contract` is implemented inside `packages/atlas-search`.
