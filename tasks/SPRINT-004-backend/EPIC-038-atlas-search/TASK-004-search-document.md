...
# TASK-004 — Search Document

## Summary

Define document contracts, metadata, versions, and source payloads.
...
After this task is complete, Atlas supports the `Search Document` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Search Document**.
...
- [x] `Search Document` is implemented inside `packages/atlas-search`.
...
TASK-005-search-analyzer-contract.md
