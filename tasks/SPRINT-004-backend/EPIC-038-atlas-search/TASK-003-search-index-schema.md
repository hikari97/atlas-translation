...
# TASK-003 — Index Schema

## Summary

Define index settings, field definitions, and schema metadata.
...
After this task is complete, Atlas supports the `Index Schema` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Index Schema**.
...
- [x] `Index Schema` is implemented inside `packages/atlas-search`.
