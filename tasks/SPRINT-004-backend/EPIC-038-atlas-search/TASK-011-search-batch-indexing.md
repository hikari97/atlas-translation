...
# TASK-011 — Batch Indexing

## Summary

Implement batch indexing descriptors and result helpers.
...
After this task is complete, Atlas supports the `Batch Indexing` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Batch Indexing**.
...
- [x] `Batch Indexing` is implemented inside `packages/atlas-search`.
