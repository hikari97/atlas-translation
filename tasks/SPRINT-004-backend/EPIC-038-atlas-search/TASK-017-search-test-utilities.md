...
# TASK-017 — Search Test Utilities

## Summary

Create fixtures, fake analyzers, and search assertions.
...
After this task is complete, Atlas supports the `Search Test Utilities` capability for `atlas-search`.

---

# Goal

Implement the smallest production-quality increment needed for **Search Test Utilities**.
...
- [x] `Search Test Utilities` is implemented inside `packages/atlas-search`.
