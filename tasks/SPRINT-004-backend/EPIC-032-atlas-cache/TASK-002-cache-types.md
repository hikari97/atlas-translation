...
# TASK-002 — Cache Core Types

## Summary

Define cache identifiers, values, operation options, and result contracts.
...
After this task is complete, Atlas supports the `Cache Core Types` capability for `atlas-cache`.

---

# Goal

Implement the smallest production-quality increment needed for **Cache Core Types**.
...
- [x] `Cache Core Types` is implemented inside `packages/atlas-cache`.
