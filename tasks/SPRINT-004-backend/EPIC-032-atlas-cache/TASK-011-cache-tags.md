...
Implement tag metadata and tag-based invalidation boundaries.
...
After this task is complete, Atlas supports the `Cache Tags` capability for `atlas-cache`.

---

# Goal

Implement the smallest production-quality increment needed for **Cache Tags**.
...
- [x] `Cache Tags` is implemented inside `packages/atlas-cache`.
...
TASK-012-cache-stampede-protection.md
