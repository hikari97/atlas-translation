...
# TASK-010 — Cache Invalidation

## Summary

Implement invalidation helpers for keys, namespaces, and patterns.
...
After this task is complete, Atlas supports the `Cache Invalidation` capability for `atlas-cache`.

---

# Goal

Implement the smallest production-quality increment needed for **Cache Invalidation**.
...
- [x] `Cache Invalidation` is implemented inside `packages/atlas-cache`.
