...
# TASK-003 — Backend Manifest

## Summary

Define manifest contracts for enabled capabilities, modules, services, and integrations.
...
After this task is complete, Atlas supports the `Backend Manifest` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Backend Manifest**.
...
- [x] `Backend Manifest` is implemented inside `packages/atlas-backend-builder`.
...
TASK-004-backend-capability-registry.md
