---
id: TASK-011
title: Queue Worker Composition
status: Completed
priority: High
story_points: 5
...
# TASK-011 — Queue Worker Composition

## Summary

Compose queue and worker capability descriptors.
...
After this task is complete, Atlas supports the `Queue Worker Composition` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Queue Worker Composition**.
...
- [x] `Queue Worker Composition` is implemented inside `packages/atlas-backend-builder`.
...
TASK-012-backend-scheduler-composition.md
