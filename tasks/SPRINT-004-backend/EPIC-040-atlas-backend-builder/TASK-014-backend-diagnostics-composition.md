...
# TASK-014 — Diagnostics Composition

## Summary

Compose health checks, diagnostics events, and build inspection payloads.
...
After this task is complete, Atlas supports the `Diagnostics Composition` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Diagnostics Composition**.
...
- [x] `Diagnostics Composition` is implemented inside `packages/atlas-backend-builder`.
...
TASK-015-backend-build-plan.md
