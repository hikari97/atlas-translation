...
# TASK-012 — Scheduler Composition

## Summary

Compose scheduler capability descriptors and scheduled worker wiring boundaries.
...
After this task is complete, Atlas supports the `Scheduler Composition` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Scheduler Composition**.
...
- [x] `Scheduler Composition` is implemented inside `packages/atlas-backend-builder`.
...
TASK-013-backend-mail-search-notification-composition.md
