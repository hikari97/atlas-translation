...
# TASK-006 — Runtime Composition

## Summary

Compose runtime lifecycle boundaries using atlas-runtime public API.
...
After this task is complete, Atlas supports the `Runtime Composition` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Runtime Composition**.
...
- [x] `Runtime Composition` is implemented inside `packages/atlas-backend-builder`.
...
TASK-007-backend-container-composition.md
