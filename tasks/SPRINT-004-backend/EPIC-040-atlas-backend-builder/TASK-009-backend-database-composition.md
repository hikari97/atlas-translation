...
# TASK-009 — Database Composition

## Summary

Compose database capability descriptors using atlas-database public API.
...
After this task is complete, Atlas supports the `Database Composition` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Composition**.
...
- [x] `Database Composition` is implemented inside `packages/atlas-backend-builder`.
...
TASK-010-backend-cache-storage-composition.md
