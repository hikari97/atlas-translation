---
id: TASK-002
title: Backend Builder Core Types
status: Completed
priority: High
story_points: 5
...
# TASK-002 — Backend Builder Core Types

## Summary

Define builder IDs, build phases, options, results, and diagnostics contracts.
...
After this task is complete, Atlas supports the `Backend Builder Core Types` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Backend Builder Core Types**.
...
- [x] `Backend Builder Core Types` is implemented inside `packages/atlas-backend-builder`.
