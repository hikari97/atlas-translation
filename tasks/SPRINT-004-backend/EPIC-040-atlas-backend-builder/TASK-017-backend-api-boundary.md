...
# TASK-017 — Apps API Boundary

## Summary

Define the boundary for apps/api to consume backend-builder without modifying apps/api.
...
After this task is complete, Atlas supports the `Apps API Boundary` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Apps API Boundary**.
...
- [x] `Apps API Boundary` is implemented inside `packages/atlas-backend-builder`.
...
TASK-018-backend-builder-public-api.md
