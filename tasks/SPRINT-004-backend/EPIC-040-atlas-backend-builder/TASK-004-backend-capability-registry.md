...
# TASK-004 — Capability Registry

## Summary

Implement capability registry descriptors without dynamic package installation.
...
After this task is complete, Atlas supports the `Capability Registry` capability for `atlas-backend-builder`.

---

# Goal

Implement the smallest production-quality increment needed for **Capability Registry**.
...
- [x] `Capability Registry` is implemented inside `packages/atlas-backend-builder`.
...
TASK-005-backend-config-composition.md
