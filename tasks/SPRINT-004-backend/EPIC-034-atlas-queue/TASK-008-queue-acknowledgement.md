...
# TASK-008 — Acknowledgement

## Summary

Implement ack/nack and message settlement contracts.
...
After this task is complete, Atlas supports the `Acknowledgement` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Acknowledgement**.
...
- [x] `Acknowledgement` is implemented inside `packages/atlas-queue`.
...
TASK-009-queue-retry-policy.md
