...
# TASK-002 — Queue Core Types

## Summary

Define queue names, message IDs, operation options, and result contracts.
...
After this task is complete, Atlas supports the `Queue Core Types` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Queue Core Types**.
...
- [x] `Queue Core Types` is implemented inside `packages/atlas-queue`.
...
TASK-003-queue-message-envelope.md
