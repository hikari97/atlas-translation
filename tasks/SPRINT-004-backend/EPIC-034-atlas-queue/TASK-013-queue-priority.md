...
Implement priority metadata and comparison helpers.
...
After this task is complete, Atlas supports the `Priority` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Priority**.
...
- [x] `Priority` is implemented inside `packages/atlas-queue`.
