...
# TASK-005 — Memory Queue Adapter

## Summary

Implement deterministic in-memory queue adapter for tests and development.
...
After this task is complete, Atlas supports the `Memory Queue Adapter` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Memory Queue Adapter**.
...
- [x] `Memory Queue Adapter` is implemented inside `packages/atlas-queue`.
