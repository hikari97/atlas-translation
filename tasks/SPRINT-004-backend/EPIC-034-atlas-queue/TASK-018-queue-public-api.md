...
After this task is complete, Atlas supports the `Queue Public API` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Queue Public API**.
...
- [x] `Queue Public API` is implemented inside `packages/atlas-queue`.
