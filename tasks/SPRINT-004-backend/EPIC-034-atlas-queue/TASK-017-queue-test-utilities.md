...
# TASK-017 — Queue Test Utilities

## Summary

Create fake queues, fixtures, and handler assertions.
...
After this task is complete, Atlas supports the `Queue Test Utilities` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Queue Test Utilities**.
...
- [x] `Queue Test Utilities` is implemented inside `packages/atlas-queue`.
