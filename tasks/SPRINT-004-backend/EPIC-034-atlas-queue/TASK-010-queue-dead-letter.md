...
# TASK-010 — Dead Letter Queue

## Summary

Implement dead-letter descriptors and routing boundaries.
...
After this task is complete, Atlas supports the `Dead Letter Queue` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Dead Letter Queue**.
...
- [x] `Dead Letter Queue` is implemented inside `packages/atlas-queue`.
