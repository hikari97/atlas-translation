...
# TASK-003 — Message Envelope

## Summary

Implement typed message envelope, headers, metadata, and correlation IDs.
...
After this task is complete, Atlas supports the `Message Envelope` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Message Envelope**.
...
- [x] `Message Envelope` is implemented inside `packages/atlas-queue`.
...
TASK-004-queue-adapter-contract.md
