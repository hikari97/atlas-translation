...
# TASK-012 — Delayed Jobs

## Summary

Define delayed job descriptors without scheduler coupling.
...
After this task is complete, Atlas supports the `Delayed Jobs` capability for `atlas-queue`.

---

# Goal

Implement the smallest production-quality increment needed for **Delayed Jobs**.
...
- [x] `Delayed Jobs` is implemented inside `packages/atlas-queue`.
