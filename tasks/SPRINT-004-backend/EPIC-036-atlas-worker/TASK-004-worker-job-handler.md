...
# TASK-004 — Job Handler

## Summary

Define typed job handler contracts and handler registration helpers.
...
After this task is complete, Atlas supports the `Job Handler` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Job Handler**.
...
- [x] `Job Handler` is implemented inside `packages/atlas-worker`.
...
TASK-005-worker-execution-result.md
