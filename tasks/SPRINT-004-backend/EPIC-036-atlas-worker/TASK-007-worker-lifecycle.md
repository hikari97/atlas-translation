...
# TASK-007 — Worker Lifecycle

## Summary

Implement lifecycle states, start/stop hooks, and graceful shutdown contracts.
...
After this task is complete, Atlas supports the `Worker Lifecycle` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Worker Lifecycle**.
...
- [x] `Worker Lifecycle` is implemented inside `packages/atlas-worker`.
...
TASK-008-worker-concurrency-limiter.md
