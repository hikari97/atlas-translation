...
# TASK-005 — Execution Result

## Summary

Implement success, failure, skipped, cancelled, and retryable result helpers.
...
After this task is complete, Atlas supports the `Execution Result` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Execution Result**.
...
- [x] `Execution Result` is implemented inside `packages/atlas-worker`.
