...
# TASK-017 — Worker Test Utilities

## Summary

Create fake jobs, harnesses, and handler assertions.
...
After this task is complete, Atlas supports the `Worker Test Utilities` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Worker Test Utilities**.
...
- [x] `Worker Test Utilities` is implemented inside `packages/atlas-worker`.
