...
Implement cancellation token contracts and cancellation-aware helpers.
...
After this task is complete, Atlas supports the `Cancellation` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Cancellation**.
...
- [x] `Cancellation` is implemented inside `packages/atlas-worker`.
