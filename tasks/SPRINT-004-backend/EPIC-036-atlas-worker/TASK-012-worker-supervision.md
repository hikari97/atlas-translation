...
# TASK-012 — Supervision

## Summary

Define supervision policies for controlled failure handling.
...
After this task is complete, Atlas supports the `Supervision` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Supervision**.
...
- [x] `Supervision` is implemented inside `packages/atlas-worker`.
...
TASK-013-worker-queue-integration.md
