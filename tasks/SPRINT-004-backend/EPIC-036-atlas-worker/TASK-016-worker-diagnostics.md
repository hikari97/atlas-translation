...
# TASK-016 — Worker Diagnostics

## Summary

Define diagnostics events and safe payloads for worker execution.
...
After this task is complete, Atlas supports the `Worker Diagnostics` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Worker Diagnostics**.
...
- [x] `Worker Diagnostics` is implemented inside `packages/atlas-worker`.
...
TASK-017-worker-test-utilities.md
