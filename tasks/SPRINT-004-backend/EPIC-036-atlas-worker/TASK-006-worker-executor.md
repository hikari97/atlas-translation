...
# TASK-006 — Worker Executor

## Summary

Implement handler execution orchestration with explicit error handling.
...
After this task is complete, Atlas supports the `Worker Executor` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Worker Executor**.
...
- [x] `Worker Executor` is implemented inside `packages/atlas-worker`.
