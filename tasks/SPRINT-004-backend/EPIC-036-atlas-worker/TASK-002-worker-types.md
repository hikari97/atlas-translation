...
# TASK-002 — Worker Core Types

## Summary

Define worker IDs, job IDs, execution options, states, and result contracts.
...
After this task is complete, Atlas supports the `Worker Core Types` capability for `atlas-worker`.

---

# Goal

Implement the smallest production-quality increment needed for **Worker Core Types**.
...
- [x] `Worker Core Types` is implemented inside `packages/atlas-worker`.
