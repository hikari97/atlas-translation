...
# TASK-003 — Config Schema

## Summary

Implement a provider-independent schema model used to describe config fields, defaults, validation rules, documentation, and deprecation metadata.
