...
# TASK-004 — Config Defaults

## Summary

Implement default configuration support using schema defaults and explicit default providers without relying on process environment or filesystem APIs.
...
- Tests for deterministic defaults.
