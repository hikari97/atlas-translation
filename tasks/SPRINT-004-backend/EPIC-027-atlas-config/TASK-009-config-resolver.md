...
# TASK-009 — Config Resolver

## Summary

Resolve configuration by combining schema, defaults, parsed input, validation, normalization, and diagnostics into one public resolver flow.
