...
# TASK-006 — Config Parser

## Summary

Implement parsing utilities that convert raw objects into normalized config input while preserving errors, paths, and source metadata.
