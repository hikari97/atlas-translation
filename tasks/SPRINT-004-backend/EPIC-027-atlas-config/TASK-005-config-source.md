...
# TASK-005 — Config Source

## Summary

Define config source abstractions for memory, object, static, and future external sources without implementing filesystem or network access yet.
