...
# TASK-008 — Config Normalizer

## Summary

Normalize validated config values into a stable internal representation with predictable key ordering and readonly output.
