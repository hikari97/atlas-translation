...
# TASK-011 — Config Environment

## Summary

Implement environment-aware config overlays without directly reading process.env; environment data must be injected through an explicit adapter.
