...
# TASK-007 — Config Validator

## Summary

Implement schema-based validation for parsed configuration including required fields, type checks, enum checks, custom validators, and warnings.
