...
Detect circular module dependencies with actionable diagnostics.

---

## Goal

Implement module cycle detection for `atlas-module` while keeping the package framework-independent, type-safe, deterministic, and isolated from app/runtime-specific infrastructure.
...
- Return cycle paths in diagnostics.
- Ensure cycle errors identify the modules involved and dependency edge type.
- Make cycle detection deterministic.

### Excluded

- Do not execute lifecycle hooks.
- Do not auto-resolve cycles.
...
- Direct cycles are detected.
- Indirect cycles are detected.
- Diagnostics include actionable cycle path details.
- Valid acyclic graphs pass.

---

## Testing

- Test direct dependency cycle.
- Test indirect dependency cycle.
- Test acyclic graph.
