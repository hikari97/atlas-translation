...
# TASK-012 — Mail Preview

## Summary

Implement preview result contracts for development and tests.
...
After this task is complete, Atlas supports the `Mail Preview` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Preview**.
...
- [x] `Mail Preview` is implemented inside `packages/atlas-mail`.
...
TASK-013-mail-queue-integration.md
