...
After this task is complete, Atlas supports the `Mail Public API` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Public API**.
...
- [x] `Mail Public API` is implemented inside `packages/atlas-mail`.
