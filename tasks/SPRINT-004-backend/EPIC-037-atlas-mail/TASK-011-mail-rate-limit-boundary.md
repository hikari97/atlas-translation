...
# TASK-011 — Rate Limit Boundary

## Summary

Define mail rate-limit metadata and decision contracts.
...
After this task is complete, Atlas supports the `Rate Limit Boundary` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Rate Limit Boundary**.
...
- [x] `Rate Limit Boundary` is implemented inside `packages/atlas-mail`.
