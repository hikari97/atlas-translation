...
# TASK-005 — Mail Template

## Summary

Define template contracts without coupling to a rendering engine.
...
After this task is complete, Atlas supports the `Mail Template` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Template**.
...
- [x] `Mail Template` is implemented inside `packages/atlas-mail`.
...
TASK-006-mail-transport-contract.md
