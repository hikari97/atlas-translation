...
# TASK-014 — Config Integration

## Summary

Expose atlas-config integration boundary for mail configuration.
...
After this task is complete, Atlas supports the `Config Integration` capability for `atlas-mail`.
...
- [x] `Config Integration` is implemented inside `packages/atlas-mail`.
...
TASK-015-mail-notification-boundary.md
