...
# TASK-016 — Mail Diagnostics

## Summary

Define diagnostics events and safe payloads for mail operations.
...
After this task is complete, Atlas supports the `Mail Diagnostics` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Diagnostics**.
...
- [x] `Mail Diagnostics` is implemented inside `packages/atlas-mail`.
...
TASK-017-mail-test-utilities.md
