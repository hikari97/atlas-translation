...
# TASK-017 — Mail Test Utilities

## Summary

Create fake transports, fixtures, and send assertions.
...
After this task is complete, Atlas supports the `Mail Test Utilities` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Test Utilities**.
...
- [x] `Mail Test Utilities` is implemented inside `packages/atlas-mail`.
