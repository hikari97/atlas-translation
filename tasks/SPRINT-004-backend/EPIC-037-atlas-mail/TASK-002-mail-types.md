...
# TASK-002 — Mail Core Types

## Summary

Define mail IDs, provider IDs, operation options, and result contracts.
...
After this task is complete, Atlas supports the `Mail Core Types` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Core Types**.
...
- [x] `Mail Core Types` is implemented inside `packages/atlas-mail`.
