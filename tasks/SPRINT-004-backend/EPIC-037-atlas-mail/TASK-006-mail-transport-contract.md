...
# TASK-006 — Transport Contract

## Summary

Define mail transport contracts without SMTP/provider coupling.
...
After this task is complete, Atlas supports the `Transport Contract` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Transport Contract**.
...
- [x] `Transport Contract` is implemented inside `packages/atlas-mail`.
...
TASK-007-mail-development-transport.md
