...
# TASK-003 — Mail Address

## Summary

Implement email address and recipient validation boundaries.
...
After this task is complete, Atlas supports the `Mail Address` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Address**.
...
- [x] `Mail Address` is implemented inside `packages/atlas-mail`.
