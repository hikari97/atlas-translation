...
# TASK-004 — Mail Message

## Summary

Implement message contracts for sender, recipients, subject, body, headers, and metadata.
...
After this task is complete, Atlas supports the `Mail Message` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Mail Message**.
...
- [x] `Mail Message` is implemented inside `packages/atlas-mail`.
