...
Define attachment metadata and safe payload boundaries.
...
After this task is complete, Atlas supports the `Attachments` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Attachments**.
...
- [x] `Attachments` is implemented inside `packages/atlas-mail`.
...
TASK-010-mail-retry-boundary.md
