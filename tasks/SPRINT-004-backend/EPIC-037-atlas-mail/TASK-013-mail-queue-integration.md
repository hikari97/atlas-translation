...
# TASK-013 — Queue Integration

## Summary

Expose asynchronous mail delivery boundaries to atlas-queue.
...
After this task is complete, Atlas supports the `Queue Integration` capability for `atlas-mail`.
...
- [x] `Queue Integration` is implemented inside `packages/atlas-mail`.
...
TASK-014-mail-config-integration.md
