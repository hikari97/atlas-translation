...
# TASK-015 — Notification Boundary

## Summary

Expose email channel boundary for atlas-notification without cyclic imports.
...
After this task is complete, Atlas supports the `Notification Boundary` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Notification Boundary**.
...
- [x] `Notification Boundary` is implemented inside `packages/atlas-mail`.
