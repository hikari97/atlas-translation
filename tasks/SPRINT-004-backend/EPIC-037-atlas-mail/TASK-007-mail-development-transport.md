...
# TASK-007 — Development Transport

## Summary

Implement in-memory/dev transport for tests and local development.
...
After this task is complete, Atlas supports the `Development Transport` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Development Transport**.
...
- [x] `Development Transport` is implemented inside `packages/atlas-mail`.
...
TASK-008-mail-send-pipeline.md
