...
# TASK-010 — Retry Boundary

## Summary

Define retry descriptors and retry decisions without worker implementation.
...
After this task is complete, Atlas supports the `Retry Boundary` capability for `atlas-mail`.

---

# Goal

Implement the smallest production-quality increment needed for **Retry Boundary**.
...
- [x] `Retry Boundary` is implemented inside `packages/atlas-mail`.
...
TASK-011-mail-rate-limit-boundary.md
