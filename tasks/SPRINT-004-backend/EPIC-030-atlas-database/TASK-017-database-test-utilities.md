...
Create fakes, fixtures, and deterministic test helpers.
...
After this task is complete, Atlas supports the `Database Test Utilities` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Test Utilities**.
...
- [x] `Database Test Utilities` is implemented inside `packages/atlas-database`.
...
TASK-018-database-public-api.md
