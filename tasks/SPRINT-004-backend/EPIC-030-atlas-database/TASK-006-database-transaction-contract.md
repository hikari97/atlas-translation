---
id: TASK-006
title: Database Transaction Contract
status: Completed
priority: High
story_points: 5
...
Define transaction context, transaction options, and transaction result contracts.
...
After this task is complete, Atlas supports the `Database Transaction Contract` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Transaction Contract**.
...
- [x] `Database Transaction Contract` is implemented inside `packages/atlas-database`.
...
TASK-007-database-transaction-runner.md
