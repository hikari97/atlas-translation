...
Implement provider-neutral health check contracts and result helpers.
...
After this task is complete, Atlas supports the `Database Health Check` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Health Check**.
...
- [x] `Database Health Check` is implemented inside `packages/atlas-database`.
...
TASK-013-database-error-model.md
