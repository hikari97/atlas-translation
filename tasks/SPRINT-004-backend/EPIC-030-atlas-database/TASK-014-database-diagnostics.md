...
Define diagnostics events and safe payloads for database operations.
...
After this task is complete, Atlas supports the `Database Diagnostics` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Diagnostics**.
...
- [x] `Database Diagnostics` is implemented inside `packages/atlas-database`.
...
TASK-015-database-config-integration.md
