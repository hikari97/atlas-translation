...
# TASK-011 — Migration Runner

## Summary

Implement deterministic migration runner orchestration over migration descriptors.
...
After this task is complete, Atlas supports the `Migration Runner` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Migration Runner**.
...
- [x] `Migration Runner` is implemented inside `packages/atlas-database`.
...
TASK-012-database-health-check.md
