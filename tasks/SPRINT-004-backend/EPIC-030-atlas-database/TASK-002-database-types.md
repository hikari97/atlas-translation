...
Define provider-neutral database identifiers, states, options, results, and metadata.
...
After this task is complete, Atlas supports the `Database Core Types` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Core Types**.
...
- [x] `Database Core Types` is implemented inside `packages/atlas-database`.
...
TASK-003-database-connection-config.md
