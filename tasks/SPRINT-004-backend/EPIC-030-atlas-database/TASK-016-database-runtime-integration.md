...
Expose atlas-runtime registration hooks for database capability.
...
After this task is complete, Atlas supports the `Runtime Integration` capability for `atlas-database`.
...
- [x] `Runtime Integration` is implemented inside `packages/atlas-database`.
...
TASK-017-database-test-utilities.md
