...
Implement typed database errors, error codes, and safe serialization helpers.
...
After this task is complete, Atlas supports the `Database Error Model` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Error Model**.
...
- [x] `Database Error Model` is implemented inside `packages/atlas-database`.
...
TASK-014-database-diagnostics.md
