...
After this task is complete, Atlas supports the `Database Public API` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Public API**.
...
- [x] `Database Public API` is implemented inside `packages/atlas-database`.
