...
Implement query result, affected-row, pagination, and operation result helpers.
...
After this task is complete, Atlas supports the `Database Query Result` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Query Result**.
...
- [x] `Database Query Result` is implemented inside `packages/atlas-database`.
...
TASK-009-database-repository-primitive.md
