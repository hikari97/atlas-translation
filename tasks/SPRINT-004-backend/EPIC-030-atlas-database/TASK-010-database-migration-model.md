...
# TASK-010 — Migration Model

## Summary

Define migration descriptors, direction, status, and execution records.
...
After this task is complete, Atlas supports the `Migration Model` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Migration Model**.
...
- [x] `Migration Model` is implemented inside `packages/atlas-database`.
...
TASK-011-database-migration-runner.md
