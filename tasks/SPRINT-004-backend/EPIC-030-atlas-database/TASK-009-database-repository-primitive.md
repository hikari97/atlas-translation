...
# TASK-009 — Repository Primitive

## Summary

Implement minimal repository boundary contracts without ORM behavior.
...
After this task is complete, Atlas supports the `Repository Primitive` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Repository Primitive**.
...
- [x] `Repository Primitive` is implemented inside `packages/atlas-database`.
...
TASK-010-database-migration-model.md
