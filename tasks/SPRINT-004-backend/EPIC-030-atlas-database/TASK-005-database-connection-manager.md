...
Implement connection lifecycle coordination around the client boundary.
...
After this task is complete, Atlas supports the `Database Connection Manager` capability for `atlas-database`.

---

# Goal

Implement the smallest production-quality increment needed for **Database Connection Manager**.
...
- [x] `Database Connection Manager` is implemented inside `packages/atlas-database`.
...
TASK-006-database-transaction-contract.md
